import{d as H,r as f,c as z,s as I,x as P,k as q,b as c,g as p,m as G,l as W,u as k,F as j,e as J,i as _,j as S,o as t,t as U,A as R,f as F,y as A}from"./iframe-DQPhCJt3.js";import{C as $}from"./chevron-down-CXcF9qSO.js";import{C as Q}from"./check-Cx_mo0q9.js";import{_ as T}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{U as l}from"./user-e8mbn7LZ.js";import{c as K}from"./createLucideIcon-D8o8pLjL.js";import"./preload-helper-Ct5FWWRu.js";/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w=K("circle-question-mark",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]),X={class:"fu-combobox__control"},Y=["value","placeholder","disabled"],Z={key:0,class:"fu-combobox__dropdown scrollbar__control customScrollBar"},ee={class:"fu-combobox__group-title"},oe=["onClick"],ne={class:"fu-combobox__option-left"},ae={class:"fu-combobox__option-right"},le={key:1,class:"fu-combobox__empty"},O=H({__name:"FuCombobox",props:{options:{},modelValue:{},placeholder:{},disabled:{type:Boolean}},emits:["update:modelValue"],setup(r,{emit:B}){const m=r,M=B,i=f(!1),u=f(""),n=f(null),x=f(null),y=z(()=>{if(!u.value||n.value&&u.value.toLowerCase()===n.value.label.toLowerCase())return C(m.options);const e=m.options.filter(a=>a.label.toLowerCase().includes(u.value.toLowerCase()));return C(e)});function C(e){const a={};return e.forEach(s=>{const o=s.group||"Options";a[o]||(a[o]=[]),a[o].push(s)}),Object.entries(a).map(([s,o])=>({title:s,items:o}))}I(()=>m.modelValue,e=>{n.value=m.options.find(a=>a.value===e)||null,!i.value&&n.value&&(u.value=n.value.label)},{immediate:!0});function L(e){u.value=e.target.value}function N(e){n.value=e,u.value=e.label,M("update:modelValue",e.value),i.value=!1}function E(){i.value=!i.value}function D(e){x.value&&!x.value.contains(e.target)&&(i.value=!1,n.value&&(u.value=n.value.label))}return P(()=>{document.addEventListener("click",D)}),q(()=>{document.removeEventListener("click",D)}),(e,a)=>(t(),c("div",{class:S(["fu-combobox",{"fu-combobox--disabled":r.disabled}]),ref_key:"comboboxRef",ref:x},[p("div",X,[p("input",{type:"text",value:i.value?u.value:n.value?.label||"",placeholder:r.placeholder,class:"fu-combobox__input",disabled:r.disabled,onInput:L,onFocus:a[0]||(a[0]=s=>!r.disabled&&(i.value=!0))},null,40,Y),p("span",{class:"fu-combobox__icon",onClick:G(E,["stop"])},[W(k($),{size:18,"stroke-width":1})])]),i.value&&!r.disabled?(t(),c("div",Z,[y.value.length>0?(t(!0),c(j,{key:0},J(y.value,s=>(t(),c("div",{key:s.title,class:"fu-combobox__group"},[p("div",ee,U(s.title),1),(t(!0),c(j,null,J(s.items,o=>(t(),c("div",{key:o.value,class:S(["fu-combobox__option",{"fu-combobox__option--selected":o.value===n.value?.value}]),onClick:se=>N(o)},[p("div",ne,[R(e.$slots,"option",{option:o},()=>[o.icon?(t(),F(A(o.icon),{key:0,class:"fu-combobox__option-icon"})):_("",!0),p("span",null,U(o.label),1)],!0)]),p("div",ae,[o.value===n.value?.value?(t(),F(k(Q),{key:0,class:"fu-combobox__check"})):_("",!0)])],10,oe))),128))]))),128)):(t(),c("div",le,"No results found"))])):_("",!0)],2))}}),V=T(O,[["__scopeId","data-v-e8069cc4"]]);O.__docgenInfo={exportName:"default",displayName:"FuCombobox",description:"",tags:{},props:[{name:"options",required:!0,type:{name:"Array",elements:[{name:"ComboboxOption"}]}},{name:"modelValue",required:!1,type:{name:"union",elements:[{name:"string"},{name:"number"},{name:"null"}]}},{name:"placeholder",required:!1,type:{name:"string"}},{name:"disabled",required:!1,type:{name:"boolean"}}],events:[{name:"update:modelValue",type:{names:["union"],elements:[{name:"string"},{name:"number"},{name:"null"}]}}],slots:[{name:"option",scoped:!0,bindings:[{name:"option",title:"binding"}]}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/combobox/FuCombobox.vue"]};const de={title:"Fusion/Forms/Selection/FuCombobox",component:V,tags:["autodocs"],argTypes:{placeholder:{control:"text",description:"Placeholder text when no option is selected"},options:{control:"object",description:"Array of options with { label, value, icon?, group? }"},modelValue:{control:"text",description:"v-model binding for selected value"},disabled:{control:"boolean",description:"Disables the combobox"}},parameters:{docs:{description:{component:`
