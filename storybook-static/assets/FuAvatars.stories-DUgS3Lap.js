import{d as A,b as c,F as y,e as F,u as S,j as x,t as U,i as h,o as r,f as D,r as w}from"./iframe-DQPhCJt3.js";import{F as e,U as k}from"./FuAvatar-BuFWWmeo.js";import{_ as z}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const p=A({__name:"FuAvatarGroup",props:{users:{},max:{},size:{}},emits:["click"],setup(a){const t=a,l=t.max??3,g=t.users.slice(0,l),d=t.users.length-l;return(b,v)=>(r(),c("div",{class:"fu-avatar-group",onClick:v[0]||(v[0]=s=>b.$emit("click"))},[(r(!0),c(y,null,F(S(g),(s,f)=>(r(),D(e,{key:s.id||f,src:s.src,name:s.name,alt:s.alt,size:a.size},null,8,["src","name","alt","size"]))),128)),d>0?(r(),c("div",{key:0,class:x(["fu-avatar fu-avatar--more",`fu-avatar--${a.size}`])}," +"+U(d),2)):h("",!0)]))}}),I=z(p,[["__scopeId","data-v-d339fd2f"]]);p.__docgenInfo={exportName:"default",displayName:"FuAvatarGroup",description:"",tags:{},props:[{name:"users",required:!0,type:{name:"Array",elements:[{name:"User"}]}},{name:"max",required:!1,type:{name:"number"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"xs"'},{name:'"sm"'},{name:'"md"'},{name:'"lg"'},{name:'"xl"'},{name:'"2xl"'},{name:'"3xl"'}]}}],events:[{name:"click"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/avatar/FuAvatarGroup.vue"]};const O={title:"Fusion/Data Display/FuAvatar",component:e,tags:["autodocs"],parameters:{docs:{description:{component:`
...
*Tip: You may pass numeric backend values or \`UserStatus.Active\` enum for the status prop.*
    ...
    `}),args:{src:"/src/stories/assets/avatars/119d9abaee7a1e987571f0fe776bd1a5.png",size:"md"}},u={render:a=>({components:{FuAvatarGroup:I},setup(){return{args:a}},template:'<FuAvatarGroup v-bind="args" />'}),args:{users:[{src:"",alt:"A",name:"Kehinde Akinbola"},{src:"/src/stories/assets/avatars/70a23294beb91b4ad5a439e2c6ea5a6d.png",alt:"B",name:"Alex Johnson"},{src:"/src/stories/assets/avatars/cae99bb14b21ec41ecf03b58f59ff292.png",alt:"C",name:"Adisa Ola"},{src:"/src/stories/assets/avatars/119d9abaee7a1e987571f0fe776bd1a5.png",alt:"D",name:"Funke Ade"},{src:"/src/stories/assets/avatars/9854663aec5741bbbe84290b6edc0aed.png",alt:"E",name:"Tom Jas"}],max:3,size:"sm"}},m={render:a=>({components:{FuAvatar:e},setup(){return{avatar:w(a.src),args:a}},template:`
      <FuAvatar
        v-bind="args"
        v-model:src="avatar"
        editable
