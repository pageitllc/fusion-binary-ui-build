import{d as C,r,x as k,k as N,b as p,g as i,f as m,y as D,j as F,u as x,t as T,i as b,l as S,w as _,z as A,T as B,o,n as I,A as E}from"./iframe-DQPhCJt3.js";import{c as V}from"./createLucideIcon-D8o8pLjL.js";import{_ as M}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h=V("bell",[["path",{d:"M10.268 21a2 2 0 0 0 3.464 0",key:"vwvbt9"}],["path",{d:"M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326",key:"11g9vi"}]]),P={class:"fu-bell-icon"},j={key:2,class:"fu-badge"},v=C({__name:"FuNotification",props:{unreadCount:{default:0},bellIcon:{default:void 0},align:{default:"right"},bellClass:{default:""},bellStyle:{default:"light"}},setup(e){const s=e,a=r(!1),l=r(null),c=r(null),g=r({}),w=()=>{if(a.value=!a.value,a.value&&l.value){const n=l.value.getBoundingClientRect();let t=n.left+window.scrollX;s.align==="right"?t=n.right+window.scrollX-300:s.align==="center"&&(t=n.left+window.scrollX-160+n.width/2),g.value={top:`${n.bottom+window.scrollY+8}px`,left:`${Math.max(t,8)}px`,position:"absolute",zIndex:"2000"}}},y=n=>{const t=n.target;a.value&&l.value&&!l.value.contains(t)&&(!c.value||!c.value.contains(t))&&(a.value=!1)};return k(()=>document.addEventListener("click",y)),N(()=>document.removeEventListener("click",y)),(n,t)=>(o(),p("div",{class:"fu-notification-dropdown",ref_key:"dropdown",ref:l},[i("div",{class:"fu-notification__trigger",onClick:w},[i("div",P,[e.bellIcon?(o(),m(D(e.bellIcon),{key:0,"stroke-width":1.5,class:"fu-bell-svg"})):(o(),m(x(h),{key:1,class:F(["fu-bell-svg",[s.bellStyle,s.bellClass]])},null,8,["class"])),e.unreadCount>0?(o(),p("span",j,T(e.unreadCount),1)):b("",!0)])]),(o(),m(B,{to:"body"},[S(A,{name:"fade"},{default:_(()=>[a.value?(o(),p("div",{key:0,ref_key:"panelEl",ref:c,class:"fu-notification__panel",style:I(g.value)},[E(n.$slots,"default",{},()=>[t[0]||(t[0]=i("div",{class:"fu-empty"},[i("h4",null,"No Content"),i("p",null,"Use the default slot to pass custom dropdown body.")],-1))],!0)],4)):b("",!0)]),_:3})]))],512))}}),f=M(v,[["__scopeId","data-v-b710a214"]]);v.__docgenInfo={exportName:"default",displayName:"FuNotification",description:"",tags:{},props:[{name:"unreadCount",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"bellIcon",required:!1,type:{name:"any"},defaultValue:{func:!1,value:"undefined"}},{name:"align",required:!1,type:{name:"union",elements:[{name:'"left"'},{name:'"center"'},{name:'"right"'}]},defaultValue:{func:!1,value:'"right"'}},{name:"bellClass",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"bellStyle",required:!1,type:{name:"union",elements:[{name:'"light"'},{name:'"dark"'}]},defaultValue:{func:!1,value:'"light"'}}],slots:[{name:"default"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/notification/FuNotification.vue"]};const O={title:"Fusion/Menus/FuNotificationDropdown",component:f,tags:["autodocs"],parameters:{docs:{description:{component:`
...
\`\`\`
    ...
    `}),args:{unreadCount:3,align:"right",bellIcon:h,bellStyle:"light",bellClass:""},parameters:{docs:{description:{story:"The default example displays an unread badge and a custom dropdown body listing recent notifications."}}}},u={render:e=>({components:{FuNotificationDropdown:f},setup(){return{args:e}},template:`
      <div style="display: flex; justify-content: center; padding: 2rem;">
        <FuNotificationDropdown v-bind="args">
          <div style="padding: 1rem;">
...
}`,...u.parameters?.docs?.source}}};const R=["Default","WithCustomClass"];export{d as Default,u as WithCustomClass,R as __namedExportsOrder,O as default};
