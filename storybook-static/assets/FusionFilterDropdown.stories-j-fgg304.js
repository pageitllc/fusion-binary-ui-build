import{d as E,r as s,c as J,s as L,x as $,k as N,b as x,g as f,A as D,f as z,l as y,w as R,z as j,T as M,o as g,n as P,j as q,t as V,u as I,i as b,p as k}from"./iframe-DQPhCJt3.js";import{F as c}from"./FusionButton-BZkn3sOM.js";import{F as X}from"./FusionActionButton-BLz_V-Vj.js";import{X as Y}from"./x-DFlIIf-v.js";import{_ as G}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{F as H}from"./FusionAutocomplete-D5FDki4j.js";import"./preload-helper-Ct5FWWRu.js";import"./createLucideIcon-D8o8pLjL.js";import"./FusionTextInput-BE2hkcFJ.js";import"./FuAvatar-BuFWWmeo.js";const K={key:0,class:"fu-filter-dropdown__header"},Q={class:"fu-filter-dropdown__title"},Z={class:"fu-filter-dropdown__body"},ee={class:"fu-filter-dropdown__footer"},_=E({__name:"FusionFilterDropdown",props:{align:{default:"left"},isOpen:{type:Boolean,default:void 0},payload:{},title:{default:""},width:{default:280},maxWidth:{default:360}},emits:["apply","cancel","open","close","update:isOpen"],setup(o,{emit:l}){const e=o,n=l,a=s(!1),p=s(null),i=s(null),d=s({top:"0px",left:"0px"}),B=J(()=>({width:typeof e.width=="number"?`${e.width}px`:e.width,maxWidth:typeof e.maxWidth=="number"?`${e.maxWidth}px`:e.maxWidth}));L(()=>e.isOpen,t=>{typeof t=="boolean"&&(a.value=t,t?(n("open"),k(C)):n("close"))});function S(t){t?.stopPropagation();const r=!a.value;r&&document.dispatchEvent(new CustomEvent("close-all-dropdowns")),a.value=r,n("update:isOpen",r),r?(n("open"),k(C)):n("close")}function O(){n("apply",e.payload),u()}function T(){n("cancel"),u()}function u(){a.value&&(a.value=!1,n("update:isOpen",!1),n("close"))}function C(){if(!p.value||!i.value)return;const t=p.value.getBoundingClientRect(),r=t.bottom+window.scrollY+8;let A=t.left+window.scrollX;e.align==="center"&&(A+=t.width/2-i.value.offsetWidth/2),e.align==="right"&&(A=t.right-i.value.offsetWidth+window.scrollX),d.value={position:"absolute",top:`${r}px`,left:`${A}px`,zIndex:2e3}}function U(t){a.value&&p.value&&!p.value.contains(t.target)&&i.value&&!i.value.contains(t.target)&&u()}function W(){u()}return $(()=>{}),N(()=>{document.removeEventListener("click",U),document.removeEventListener("close-all-dropdowns",W)}),(t,r)=>(g(),x("div",{class:"fu-filter-dropdown",ref_key:"dropdown",ref:p},[f("div",{class:"fu-filter-dropdown__trigger",onClick:S},[D(t.$slots,"trigger",{},void 0,!0)]),(g(),z(M,{to:"body"},[y(j,{name:"fade"},{default:R(()=>[a.value?(g(),x("div",{key:0,ref_key:"menuRef",ref:i,class:q(["fu-filter-dropdown__menu",[`fu-filter-dropdown__menu--${o.align}`]]),style:P([d.value,B.value])},[o.title?(g(),x("div",K,[f("span",Q,V(o.title),1),y(X,{size:"sm",variant:"subtle",icon:I(Y),onClick:u},null,8,["icon"])])):b("",!0),f("div",Z,[D(t.$slots,"content",{},void 0,!0)]),f("div",ee,[D(t.$slots,"footer",{},()=>[y(c,{variant:"subtle",size:"sm",text:"Cancel",onClick:T}),y(c,{variant:"solid",size:"sm",text:"Apply",onClick:O})],!0)])],6)):b("",!0)]),_:3})]))],512))}}),m=G(_,[["__scopeId","data-v-6439f409"]]);_.__docgenInfo={exportName:"default",displayName:"FusionFilterDropdown",description:"",tags:{},props:[{name:"align",required:!1,type:{name:"union",elements:[{name:'"left"'},{name:'"center"'},{name:'"right"'}]},defaultValue:{func:!1,value:'"left"'}},{name:"isOpen",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"undefined"}},{name:"payload",required:!1,type:{name:"unknown"}},{name:"title",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"width",required:!1,type:{name:"union",elements:[{name:"number"},{name:"string"}]},defaultValue:{func:!1,value:"280"}},{name:"maxWidth",required:!1,type:{name:"union",elements:[{name:"number"},{name:"string"}]},defaultValue:{func:!1,value:"360"}}],events:[{name:"apply",type:{names:["unknown"]}},{name:"cancel"},{name:"open"},{name:"close"},{name:"update:isOpen",type:{names:["boolean"]}}],slots:[{name:"trigger"},{name:"content"},{name:"footer"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/filterDropdown/FusionFilterDropdown.vue"]};const ce={title:"Fusion/Menus/FusionFilterDropdown",component:m,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...v.parameters?.docs?.source}}};const ue=["AlignLeft","AlignCenter","AlignRight","WithAutocomplete"];export{w as AlignCenter,h as AlignLeft,F as AlignRight,v as WithAutocomplete,ue as __namedExportsOrder,ce as default};
