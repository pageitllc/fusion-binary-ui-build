import{F as l}from"./FusionListView-CP-HS6a8.js";import{F as k}from"./FuAvatar-TILl9Yp9.js";import{F}from"./FusionPagination-YDn3qlls.js";import{r as y,c as C}from"./iframe-LVkgWH8l.js";import{U as s}from"./user-BdTDMBdo.js";import{c as x}from"./createLucideIcon-BmHTr6Hj.js";import{C as o}from"./circle-check-big-DxL_9f1a.js";import{M as V}from"./mail-Dn4QP5as.js";import"./FusionCheckbox-BjwLbUdn.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./FusionStatusDropdown-AisoqI17.js";import"./chevron-down-DysxZx9k.js";import"./chevron-right-CuASwxFA.js";import"./preload-helper-Ct5FWWRu.js";/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const i=x("at-sign",[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8",key:"7n84p3"}]]);/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const r=x("users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744",key:"16gr8j"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]]),T={title:"Components/FusionListView",component:l,tags:["autodocs"],parameters:{actions:{handles:["sort-change"]},docs:{description:{component:`
...
You can disable selection per row using:
...
\`\`\`
        `}}},argTypes:{columns:{description:"Table columns. To enable sorting per column: add `sortable: true` on the column object."}}},c={render:n=>({components:{FusionListView:l,FuAvatar:k,User:s,AtSign:i,Users:r,CheckCircle:o},setup(){return{args:n}},template:`
    ...
    `}),args:{showHeader:!0,columns:[{label:"Name",key:"name",width:"200px",icon:s,textAlign:"start"},{label:"Email",key:"email",width:"220px",icon:i},{label:"Role",key:"role",icon:r,textAlign:"center"},{label:"Status",key:"status",width:"150px",icon:o,textAlign:"end"}],rows:Array.from({length:23}).map((n,e)=>({id:e+1,name:`User ${e+1}`,email:`user${e+1}@company.com`,role:e%2===0?"Developer":"Designer",status:e%3===0?"Inactive":"Active",avatar:`/avatars/user-${e%5+1}.jpg`})),options:{selectable:!0,resizeColumn:!0}}},g={name:"With Sorting (Server-side)",render:n=>({components:{FusionListView:l},setup(){const e=y([...n.rows]),a=y(null);function v(t){a.value=t;const f=[...e.value].sort((S,A)=>{const b=S[t.key],h=A[t.key];return b===h?0:t.direction==="asc"?b>h?1:-1:b<h?1:-1});e.value=f}return{args:n,rows:e,activeSort:a,handleSortChange:v}},template:`
...
{{ activeSort }}
    ...
    `}),args:{columns:[{label:"Name",key:"name",sortable:!0},{label:"Email",key:"email",sortable:!0},{label:"Role",key:"role",sortable:!1}],rows:[{id:1,name:"Charlie",email:"charlie@skkido.com",role:"Admin"},{id:2,name:"Alice",email:"alice@skkido.com",role:"User"},{id:3,name:"Bob",email:"bob@skkido.com",role:"Manager"}]}},w={name:"With Disabled Rows",args:{columns:[{label:"Name",key:"name",width:"200px",icon:s},{label:"Email",key:"email",width:"220px",icon:i},{label:"Status",key:"status",width:"150px",icon:o}],rows:[{id:1,name:"Alice",email:"alice@company.com",status:"Active"},{id:2,name:"Bob",email:"bob@company.com",status:"Locked"},{id:3,name:"Charlie",email:"charlie@company.com",status:"Active"},{id:4,name:"David",email:"david@company.com",status:"Locked"}],rowKey:"id",showHeader:!0,options:{selectable:!0,resizeColumn:!0,isRowSelectable:n=>n.status!=="Locked"}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: args => ({
    components: {
      FusionListView,
      FuAvatar,
...
}`,...w.parameters?.docs?.source}}};const $=["WithAvatar","WithoutCheckbox","Minimal","Headless","WithPagination","WithSorting","WithDisabledRows"];export{u as Headless,d as Minimal,c as WithAvatar,w as WithDisabledRows,p as WithPagination,g as WithSorting,m as WithoutCheckbox,$ as __namedExportsOrder,T as default};
