import{s as V,q as h,o as y,d as B,a as F,f as b,g as u,b as k,t as w,u as _,x as g,l as z,e as x,T as C,j as p,k as E,r as d}from"./iframe-BeZJQ65s.js";import{F as S}from"./FusionActionButton-DxSYCmZ-.js";import{F as m}from"./FusionButton-DmtKrqn1.js";import{X as T}from"./x-jetkAV5y.js";import{_ as D}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";import"./createLucideIcon-7ncFRN9y.js";const O={class:"fu-modal__header"},N={class:"fu-modal__title"},q={class:"fu-modal__body"},L={key:0,class:"fu-modal__footer"},M=V({__name:"FusionModal",props:{isVisible:{type:Boolean},title:{},size:{default:"md"},showFooter:{type:Boolean,default:!0}},emits:["close","cancel","confirm"],setup(o,{emit:e}){const s=e,n=()=>s("close");function f(t){(t.key==="Escape"||t.key==="Esc")&&n()}return h(()=>{window.addEventListener("keydown",f)}),y(()=>{window.removeEventListener("keydown",f)}),(t,v)=>(p(),B(C,{to:"body"},[o.isVisible?(p(),F("div",{key:0,class:"fu-modal__backdrop",onClick:x(n,["self"])},[u("div",{class:z(["fu-modal",`fu-modal--${o.size}`])},[u("div",O,[u("h3",N,w(o.title),1),k(S,{text:" ",icon:_(T),class:"fu-modal__close",onClick:n,variant:"ghost",size:"sm"},null,8,["icon"])]),u("div",q,[g(t.$slots,"default",{},()=>[v[0]||(v[0]=E(" Default modal content. ",-1))],!0)]),o.showFooter?(p(),F("div",L,[g(t.$slots,"footer",{},void 0,!0)])):b("",!0)],2)])):b("",!0)]))}}),c=D(M,[["__scopeId","data-v-4d75747a"]]);M.__docgenInfo={exportName:"default",displayName:"FusionModal",description:"",tags:{},props:[{name:"isVisible",required:!0,type:{name:"boolean"}},{name:"title",required:!0,type:{name:"string"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}},{name:"showFooter",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}}],events:[{name:"close"},{name:"cancel"},{name:"confirm"}],slots:[{name:"default"},{name:"footer"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/modal/FusionModal.vue"]};const j={title:"Components/Modal",component:c,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],description:"Sets the modal width (small, medium, or large)."},showFooter:{control:"boolean",description:"Toggles visibility of the footer section.",table:{defaultValue:{summary:"true"}}},title:{control:"text",description:"Sets the modal header title."}},parameters:{docs:{description:{component:`
