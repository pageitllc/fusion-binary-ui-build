import{I as T,s as O,r as i,q as V,o as U,a as u,g as w,d as f,k as x,f as b,t as y,B as D,n as q,l as F,F as P,h as M,T as $,j as l,i as j}from"./iframe-BeZJQ65s.js";import{_ as W}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{E as z}from"./ellipsis-vertical-Db7OGby1.js";import{U as K}from"./user-B_aocALJ.js";import{S as A}from"./settings-BbUxK3Y1.js";import{L as G}from"./log-out-DkEHF9sF.js";import{c as H}from"./createLucideIcon-7ncFRN9y.js";import"./preload-helper-Ct5FWWRu.js";/**
 ...
 */const J=H("chevrons-up-down",[["path",{d:"m7 15 5 5 5-5",key:"1hf1tw"}],["path",{d:"m7 9 5-5 5 5",key:"sgt6xg"}]]);/*!
  ...
  * @license MIT
  */var _;(function(e){e.pop="pop",e.push="push"})(_||(_={}));var S;(function(e){e.back="back",e.forward="forward",e.unknown=""})(S||(S={}));var I;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(I||(I={}));const N=Symbol("");function Q(){return T(N)}const X=["onClick"],L=O({__name:"FusionDropdownButton",props:{buttonText:{},buttonIcon:{},actions:{},align:{default:"right"}},setup(e){const k=e,n=i(!1),s=i(null),a=i(null),h=i({});let g=null;function R(){if(n.value=!n.value,n.value){if(g&&g!==s.value){const o=new CustomEvent("close-other-dropdowns");document.dispatchEvent(o)}g=s.value,j(B)}}function B(){const o=s.value?.querySelector("button");if(!o||!a.value)return;const c=o.getBoundingClientRect(),t=a.value.offsetWidth,r={left:`${c.left}px`,top:`${c.bottom+4}px`};k.align==="right"?r.left=`${c.right-t}px`:k.align==="center"&&(r.left=`${c.left+c.width/2-t/2}px`),h.value={position:"absolute",...r,zIndex:"1000"}}function E(o){o.onClick?.(),n.value=!1}function v(o){s.value&&!s.value.contains(o.target)&&a.value&&!a.value.contains(o.target)&&(n.value=!1)}function C(){n.value=!1}return V(()=>{document.addEventListener("click",v),document.addEventListener("close-other-dropdowns",C)}),U(()=>{document.removeEventListener("click",v),document.removeEventListener("close-other-dropdowns",C)}),(o,c)=>(l(),u("div",{class:"fu-dropdown",ref_key:"dropdown",ref:s},[w("button",{class:"fu-dropdown__button",onClick:R},[x(y(e.buttonText)+" ",1),e.buttonIcon?(l(),f(D(e.buttonIcon),{key:0,class:"fu-dropdown__icon"})):b("",!0)]),(l(),f($,{to:"body"},[n.value?(l(),u("ul",{key:0,class:F(["fu-dropdown__menu",[`fu-dropdown__menu--${e.align}`,{show:n.value}]]),style:q(h.value),ref_key:"menuRef",ref:a},[(l(!0),u(P,null,M(e.actions,t=>(l(),u("li",{key:t.label},[w("a",{class:"fu-dropdown__item",onClick:r=>E(t)},[t.icon?(l(),f(D(t.icon),{key:0,class:"fu-dropdown__icon"})):b("",!0),x(" "+y(t.label),1)],8,X)]))),128))],6)):b("",!0)]))],512))}}),Y=W(L,[["__scopeId","data-v-478aec9e"]]);L.__docgenInfo={exportName:"default",displayName:"FusionDropdownButton",description:"",tags:{},props:[{name:"buttonText",required:!0,type:{name:"string"}},{name:"buttonIcon",required:!1,type:{name:"Component"}},{name:"actions",required:!0,type:{name:"Array",elements:[{name:"Action"}]}},{name:"align",required:!1,type:{name:"union",elements:[{name:'"left"'},{name:'"center"'},{name:'"right"'}]},defaultValue:{func:!1,value:'"right"'}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/dropdown/FusionDropdownButton.vue"]};const Z=Q(),re={title:"Components/DropdownButton",component:Y,tags:["autodocs"],parameters:{docs:{description:{component:`
