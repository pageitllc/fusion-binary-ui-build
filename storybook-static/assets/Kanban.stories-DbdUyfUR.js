import{d as P,r as C,w as j,c,b as a,a as U,F as S,s as w,t as g,y as B,C as v,o as p,n as E,h as R,g as A}from"./iframe-o7SUGoga.js";import{_ as W}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const G={class:"fu-kanban scrollbar__control customScrollBar"},H=["draggable","onDragstart","onDrop"],Q={class:"fu-kanban__column-header"},X={class:"flex flex--center flex--space"},Y={class:"fu-kanban__column-title"},Z=["title"],ee={class:"fu-kanban__header-right"},te=["title","onClick"],ne={class:"flex flex--center flex--gap-sm"},oe={class:"fu-kanban__count"},ae={key:0,class:"fu-kanban__edit-body"},de=["onDragover","onDrop"],le=["onDragstart","onDrop","onClick"],se={class:"fu-kanban__card-header"},ie={class:"fu-kanban__card-body"},re={key:0,class:"fu-kanban__empty"},me=["onClick"],$=P({__name:"Kanban",props:{columns:{},editMode:{type:Boolean},addItemButtonText:{},addColumnButtonText:{},noItemtext:{}},emits:["update:columns","update:items","card-click","add-item"],setup(s,{emit:b}){const r=s,d=b,i=r.addItemButtonText||"+ Add Item",z=r.addColumnButtonText||"+ Add Stage",l=C(JSON.parse(JSON.stringify(r.columns||[]))),k=C(null),I=C(null),f=C(null);j(()=>r.columns,t=>{l.value=JSON.parse(JSON.stringify(t))},{deep:!0});function N(t,n){k.value={fromColumnId:t,item:n}}function F(t){f.value=t}function L(){f.value=null}function D(t,n){const e=k.value;if(!e)return;const m=l.value.find(u=>u.id===e.fromColumnId),o=l.value.find(u=>u.id===t);!m||!o||(m.items=m.items.filter(u=>u.id!==e.item.id),n===null?o.items.push(e.item):o.items.splice(n,0,e.item),d("update:items",l.value),k.value=null,f.value=null)}function O(t){r.editMode&&(I.value=t)}function q(t){if(!r.editMode)return;const n=I.value;if(n===null||n===t)return;const e=[...l.value],[m]=e.splice(n,1);e.splice(t,0,m),l.value=e.map((o,u)=>({...o,position:u+1})),d("update:columns",l.value),I.value=null}function J(){const t={id:`col-${l.value.length+1}`,title:`Stage ${l.value.length+1}`,color:"#8B5CF6",position:l.value.length+1,items:[]};l.value.push(t),d("update:columns",l.value)}function K(t,n){d("add-item",{column:t,index:n})}function V(t,n){d("card-click",{id:t.id,item:t,column:n})}return(t,n)=>(p(),c("div",G,[a("div",{class:"fu-kanban__columns",onDragover:n[1]||(n[1]=v(()=>{},["prevent"]))},[(p(!0),c(S,null,w(l.value,(e,m)=>(p(),c("div",{key:e.id,class:E(["fu-kanban__column",{"fu-kanban__column--drag":s.editMode}]),draggable:s.editMode,onDragstart:o=>O(m),onDrop:o=>q(m),onDragover:n[0]||(n[0]=v(()=>{},["prevent"]))},[a("header",Q,[a("div",X,[a("div",Y,[a("span",{class:"fu-kanban__dot",style:R({background:e.color||"#9ca3af"})},null,4),a("span",{class:"fu-kanban__column-name",title:e.title},g(e.title),9,Z)]),a("div",ee,[a("button",{class:"fu-kanban__add-item-btn",title:B(i),onClick:v(o=>K(e,m),["stop"])}," + ",8,te)])]),a("div",ne,[A(t.$slots,"column-header",{},void 0,!0),a("span",oe,g(e.items.length),1)])]),s.editMode?(p(),c("div",ae,[A(t.$slots,"edit-column",{column:e,index:m},void 0,!0)])):(p(),c(S,{key:1},[a("div",{class:E(["fu-kanban__cards scrollbar__control customScrollBar",{"fu-kanban__cards--hover":f.value===e.id}]),onDragover:v(o=>F(e.id),["prevent"]),onDragleave:L,onDrop:o=>D(e.id,null)},[(p(!0),c(S,null,w(e.items,(o,u)=>(p(),c("div",{key:o.id,class:"fu-kanban__card",draggable:"true",onDragstart:M=>N(e.id,o),onDrop:M=>D(e.id,u),onClick:M=>V(o,e)},[a("header",se,[a("strong",null,g(o.title),1)]),a("div",ie,[A(t.$slots,"card-body",{item:o,column:e},void 0,!0)])],40,le))),128)),e.items.length?U("",!0):(p(),c("div",re,g(s.noItemtext),1))],42,de),a("button",{class:"fu-kanban__add-card",onClick:o=>K(e,m)},g(B(i)),9,me)],64))],42,H))),128)),s.editMode?(p(),c("div",{key:0,class:"fu-kanban__add-column",onClick:J},g(B(z)),1)):U("",!0)],32)]))}}),_=W($,[["__scopeId","data-v-11abb07b"]]);$.__docgenInfo={exportName:"default",displayName:"Kanban",description:"",tags:{},props:[{name:"columns",required:!0,type:{name:"Array",elements:[{name:"KanbanColumn"}]}},{name:"editMode",required:!1,type:{name:"boolean"}},{name:"addItemButtonText",required:!1,type:{name:"string"}},{name:"addColumnButtonText",required:!1,type:{name:"string"}},{name:"noItemtext",required:!1,type:{name:"string"}}],events:[{name:"update:columns",type:{names:["Array"],elements:[{name:"KanbanColumn"}]}},{name:"update:items",type:{names:["Array"],elements:[{name:"KanbanColumn"}]}},{name:"card-click",type:{names:["{ id: string; item: KanbanItem; column: KanbanColumn }"]}},{name:"add-item",type:{names:["{ column: KanbanColumn; index: number }"]}}],slots:[{name:"column-header"},{name:"edit-column",scoped:!0,bindings:[{name:"column",title:"binding"},{name:"index",title:"binding"}]},{name:"card-body",scoped:!0,bindings:[{name:"item",title:"binding"},{name:"column",title:"binding"}]}],sourceFiles:["/Users/tommys/Documents/Skkido/Fusion-binary-ui/src/components/kanban/Kanban.vue"]};const ge={title:"Components/Kanban",component:_,tags:["autodocs"],argTypes:{columns:{control:"object",description:"List of Kanban columns containing cards (items)."},editMode:{control:"boolean",description:"Toggles between normal and edit mode (column reorder + editing)."},addItemButtonText:{control:"text",description:"Custom text for the add item button at the bottom of each column.",defaultValue:"+ Add Item"},addColumnButtonText:{control:"text",description:"Custom text for the add stage button in edit mode.",defaultValue:"+ Add Stage"}},parameters:{docs:{description:{component:`
...
\`\`\`
    ...
    `})},x={args:{columns:T,editMode:!0,addItemButtonText:"+ Add Listing",addColumnButtonText:"+ Add New Stage"},render:s=>({components:{Kanban:_},setup(){return{args:s,handleUpdateColumns:d=>{console.log("Columns reordered:",d.map(i=>i.title))},deleteStage:(d,i)=>{i.splice(d,1),console.log("Stage deleted:",d)}}},template:`
    ...
    `})},y={args:{columns:T,editMode:!1,addItemButtonText:"+ Add Deal",addColumnButtonText:"+ Add Stage"},render:s=>({components:{Kanban:_},setup(){return{args:s,handleAddItem:({column:r,index:d})=>{console.log("Add item triggered for column:",r.title,"at index:",d),alert(`Opening modal for stage: ${r.title}`)}}},template:`
