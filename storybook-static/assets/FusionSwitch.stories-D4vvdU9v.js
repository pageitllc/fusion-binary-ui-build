import{d as p,c as v,b,g,j as f,o as h,r as n}from"./iframe-DQPhCJt3.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const S=["aria-checked","disabled"],c=p({__name:"FusionSwitch",props:{modelValue:{type:Boolean},disabled:{type:Boolean},size:{}},emits:["update:modelValue"],setup(e,{emit:s}){const a=e,t=s;function m(){a.disabled||t("update:modelValue",!a.modelValue)}const u=v(()=>{switch(a.size){case"sm":return"fu-switch--sm";case"lg":return"fu-switch--lg";default:return"fu-switch--md"}});return(x,r)=>(h(),b("button",{type:"button",class:f(["fu-switch",[{"fu-switch--checked":e.modelValue,disabled:e.disabled},u.value]]),role:"switch","aria-checked":e.modelValue,disabled:e.disabled,onClick:m},[...r[0]||(r[0]=[g("span",{class:"fu-switch__thumb"},null,-1)])],10,S))}}),d=w(c,[["__scopeId","data-v-c8285d1a"]]);c.__docgenInfo={exportName:"default",displayName:"FusionSwitch",description:"",tags:{},props:[{name:"modelValue",required:!0,type:{name:"boolean"}},{name:"disabled",required:!1,type:{name:"boolean"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]}}],events:[{name:"update:modelValue",type:{names:["boolean"]}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/switch/FusionSwitch.vue"]};const V={title:"Fusion/Forms/Selection/FusionSwitch",component:d,tags:["autodocs"],parameters:{docs:{description:{component:`
