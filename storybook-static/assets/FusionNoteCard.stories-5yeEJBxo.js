import{d as h,r as v,b as m,g as o,t as p,i as f,l,w,o as u,u as b}from"./iframe-DQPhCJt3.js";import{F as y}from"./FuAvatar-BuFWWmeo.js";import{D as C}from"./DropdownMenu-CZlzQ1bU.js";import{F as N}from"./FusionActionButton-BLz_V-Vj.js";import{E as k}from"./ellipsis-vertical-ChbbuQ7O.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{S as D}from"./square-pen-XMKkucm6.js";import{T as S}from"./trash-2-_xkJDUR3.js";import{S as x}from"./share-2-CK2t9WUj.js";import"./preload-helper-Ct5FWWRu.js";import"./createLucideIcon-D8o8pLjL.js";const A={class:"fu-note-header"},E={class:"fu-note-title"},O=["innerHTML"],q={class:"fu-note-actions"},T={class:"fu-note-footer"},L={class:"fu-note-owner"},I={class:"fu-note-date"},g=h({__name:"FusionNoteCard",props:{id:{},title:{},content:{default:""},ownerName:{},ownerAvatar:{default:null},date:{},actions:{default:()=>[]}},emits:["open"],setup(e){const a=v(!1);return(i,n)=>(u(),m("div",{class:"fu-note-card",onMouseenter:n[0]||(n[0]=d=>a.value=!0),onMouseleave:n[1]||(n[1]=d=>a.value=!1),onClick:n[2]||(n[2]=d=>i.$emit("open",e.id))},[o("div",A,[o("div",E,[o("h4",null,p(e.title),1),e.content?(u(),m("div",{key:0,class:"fu-note-content",innerHTML:e.content},null,8,O)):f("",!0)]),o("div",q,[l(C,{actions:e.actions,align:"right"},{trigger:w(()=>[l(N,{icon:b(k),variant:"ghost",size:"sm",class:"fu-action-trigger"},null,8,["icon"])]),_:1},8,["actions"])])]),o("div",T,[o("div",L,[l(y,{src:e.ownerAvatar||void 0,name:e.ownerName,alt:e.ownerName,size:"xs","show-status":!1},null,8,["src","name","alt"])]),o("span",I,p(e.date),1)])],32))}}),c=F(g,[["__scopeId","data-v-5f4f6caa"]]);g.__docgenInfo={exportName:"default",displayName:"FusionNoteCard",description:"",tags:{},props:[{name:"id",required:!0,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"title",required:!0,type:{name:"string"}},{name:"content",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"ownerName",required:!0,type:{name:"string"}},{name:"ownerAvatar",required:!1,type:{name:"union",elements:[{name:"string"},{name:"null"}]},defaultValue:{func:!1,value:"null"}},{name:"date",required:!0,type:{name:"string"}},{name:"actions",required:!1,type:{name:"Array",elements:[{name:"Action"}]},defaultValue:{func:!1,value:"() => []"}}],events:[{name:"open",type:{names:["union"],elements:[{name:"string"},{name:"number"}]}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/items/notes/FusionNoteCard.vue"]};const $={title:"Fusion/Data Display/FusionNoteCard",component:c,tags:["autodocs"],parameters:{docs:{description:{component:`
...
\`\`\`
    ...
    `}),args:{id:2,title:"UI Feedback – Client Review",content:"<p>Client approved the main design but requested smaller button text and improved spacing for better readability.</p>",ownerName:"Lara Goodwin",ownerAvatar:"https://randomuser.me/api/portraits/women/45.jpg",date:"Yesterday",actions:[{label:"Edit",icon:D,onClick:()=>console.log("Edit clicked")},{label:"Delete",icon:S,onClick:()=>console.log("Delete clicked")},{label:"Share",icon:x,onClick:()=>console.log("Share clicked")}]},parameters:{docs:{description:{story:"This variant includes an action dropdown for managing the note — useful in admin or team collaboration views."}}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: args => ({
    components: {
      FusionNoteCard
    },
