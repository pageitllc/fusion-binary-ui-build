import{F as s}from"./FusionPagination-nfnRPnEw.js";import{r as p}from"./iframe-BeZJQ65s.js";import"./FusionStatusDropdown-mu6-aFVS.js";import"./chevron-down-7Eu6qkOl.js";import"./createLucideIcon-7ncFRN9y.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./chevron-right-BrJdV6Qz.js";import"./preload-helper-Ct5FWWRu.js";const b={title:"Components/FusionPagination",component:s,tags:["autodocs"],argTypes:{page:{control:{type:"number"},description:"Current page (1-based index)",table:{category:"Props",type:{summary:"number"}}},pageSize:{control:{type:"number"},description:"Number of items per page",table:{category:"Props",type:{summary:"number"}}},total:{control:{type:"number"},description:"Total number of items",table:{category:"Props",type:{summary:"number"}}},variant:{control:{type:"select"},options:["default","simple"],description:"Pagination display variant",table:{category:"Props",defaultValue:{summary:"default"},type:{summary:'"default" | "simple"'}}},showInfo:{control:{type:"boolean"},description:"Show range info (e.g. 21–40 of 137)",table:{category:"Props",defaultValue:{summary:"true"},type:{summary:"boolean"}}},siblingCount:{control:{type:"number"},description:"Number of pages shown on each side of the active page",table:{category:"Props",defaultValue:{summary:"1"},type:{summary:"number"}}}},parameters:{docs:{description:{component:`
