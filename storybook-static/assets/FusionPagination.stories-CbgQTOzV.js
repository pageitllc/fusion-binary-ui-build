import{F as d}from"./FusionPagination-D6damdBM.js";import{r as l}from"./iframe-DQPhCJt3.js";import"./FusionStatusDropdown-Fu3hoHyx.js";import"./chevron-down-CXcF9qSO.js";import"./createLucideIcon-D8o8pLjL.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./chevron-right-BFqL4mis.js";import"./preload-helper-Ct5FWWRu.js";const h={title:"Fusion/Navigation/FusionPagination",component:d,tags:["autodocs"],argTypes:{page:{control:{type:"number"},description:"Current page (1-based index)",table:{category:"Props",type:{summary:"number"}}},pageSize:{control:{type:"number"},description:"Number of items per page",table:{category:"Props",type:{summary:"number"}}},total:{control:{type:"number"},description:"Total number of items",table:{category:"Props",type:{summary:"number"}}},variant:{control:{type:"select"},options:["default","simple"],description:"Pagination display variant",table:{category:"Props",defaultValue:{summary:"default"},type:{summary:'"default" | "simple"'}}},showInfo:{control:{type:"boolean"},description:"Show range info (e.g. 21–40 of 137)",table:{category:"Props",defaultValue:{summary:"true"},type:{summary:"boolean"}}},siblingCount:{control:{type:"number"},description:"Number of pages shown on each side of the active page",table:{category:"Props",defaultValue:{summary:"1"},type:{summary:"number"}}},loading:{control:{type:"boolean"},description:"Shows skeleton state — disables controls and replaces page numbers with placeholders",table:{category:"Props",defaultValue:{summary:"false"},type:{summary:"boolean"}}}},parameters:{docs:{description:{component:`
...
}`,...p.parameters?.docs?.source}}};const S=["Default","Simple","WithoutInfo","WideRange","Loading","LoadingTransition"];export{t as Default,s as Loading,p as LoadingTransition,o as Simple,i as WideRange,r as WithoutInfo,S as __namedExportsOrder,h as default};
