import{d as C,c as R,b as p,t as g,i as F,g as l,o as f,r as u}from"./iframe-DQPhCJt3.js";import{_ as y}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const V={class:"fu-range-control"},h={key:0,class:"fu-range-label"},_={class:"fu-range-track"},S=["min","max","step","value"],k={class:"fu-range-value"},v=C({__name:"FusionRangeControl",props:{modelValue:{default:0},min:{default:0},max:{default:100},step:{default:1},label:{default:""},unit:{default:""}},emits:["update:modelValue","change"],setup(e,{emit:n}){const a=e,i=n;function b(m){const c=m.target,d=Number(c.value);i("update:modelValue",d),i("change",d)}const x=R(()=>a.unit?`${a.modelValue}${a.unit}`:String(a.modelValue));return(m,c)=>(f(),p("div",V,[e.label?(f(),p("label",h,g(e.label),1)):F("",!0),l("div",_,[l("input",{type:"range",min:e.min,max:e.max,step:e.step,value:e.modelValue,onInput:b},null,40,S),l("span",k,g(x.value),1)])]))}}),o=y(v,[["__scopeId","data-v-9c1e4c91"]]);v.__docgenInfo={exportName:"default",displayName:"FusionRangeControl",description:"",tags:{},props:[{name:"modelValue",required:!0,type:{name:"union",elements:[{name:"number"},{name:"string"}]},defaultValue:{func:!1,value:"0"}},{name:"min",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"max",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"100"}},{name:"step",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"1"}},{name:"label",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"unit",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}}],events:[{name:"update:modelValue",type:{names:["number"]}},{name:"change",type:{names:["number"]}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/rangeControl/FusionRangeControl.vue"]};const D={title:"Fusion/Forms/Selection/FusionRangeControl",component:o,tags:["autodocs"],parameters:{actions:{handles:["update:modelValue","change"]},docs:{description:{component:`
