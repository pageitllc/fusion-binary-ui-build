import{d as y,b as r,g as u,F as g,e as v,i as d,A as f,P as k,o,j as M,l as C,w as x,f as _,y as w,t as B}from"./iframe-BWX2pLPr.js";import{_ as P}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{c}from"./createLucideIcon-BuC7IBSO.js";import{C as e}from"./calendar-Dsh719-_.js";import"./preload-helper-Ct5FWWRu.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=c("list-todo",[["path",{d:"M13 5h8",key:"a7qcls"}],["path",{d:"M13 12h8",key:"h98zly"}],["path",{d:"M13 19h8",key:"c3s6r1"}],["path",{d:"m3 17 2 2 4-4",key:"1jhpwq"}],["rect",{x:"3",y:"4",width:"6",height:"6",rx:"1",key:"cif1o7"}]]),D={class:"fu-module-menu-wrapper scrollbar__control customScrollBar"},q={class:"fu-module-menu-wrapper__list"},L={key:0,class:"fu-module-menu-empty"},p=y({__name:"FusionModuleMenu",props:{items:{},activePath:{}},setup(s){return(m,A)=>{const b=k("router-link");return o(),r("div",D,[u("ul",q,[(o(!0),r(g,null,v(s.items,t=>(o(),r("li",{key:t.path,class:M({active:s.activePath&&s.activePath.startsWith(t.path)})},[C(b,{class:"fu-module-menu-link",to:t.path},{default:x(()=>[t.icon?(o(),_(w(t.icon),{key:0,size:15,class:"fu-module-menu-icon"})):d("",!0),u("span",null,B(t.label),1)]),_:2},1032,["to"])],2))),128)),!s.items||!s.items.length?(o(),r("li",L,"No menu items")):d("",!0)]),f(m.$slots,"default",{},void 0,!0)])}}}),T=P(p,[["__scopeId","data-v-7ff3c35c"]]);p.__docgenInfo={exportName:"default",displayName:"FusionModuleMenu",description:"",tags:{},props:[{name:"items",required:!0,type:{name:"Array",elements:[{name:"MenuItem"}]}},{name:"activePath",required:!1,type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/modulemenu/FusionModuleMenu.vue"]};const V={title:"Components/ModuleMenu",component:T,tags:["autodocs"],parameters:{docs:{description:{component:`
### **FusionModuleMenu**
