import{d as S,r as o,s as I,b as d,q as k,t as V,i as C,g as W,F as B,e as E,j as N,n as T,o as m,B as P,E as O,v as A,p as F}from"./iframe-DQPhCJt3.js";import{_ as K}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const M={key:0,class:"fu-input-label"},U={key:0,class:"fu-input-required"},_=["onUpdate:modelValue","onInput","onKeydown","disabled"],L={key:1,class:"fu-input-error"},x=S({__name:"FusionCodeInput",props:{modelValue:{default:""},label:{default:""},length:{default:6},size:{default:"md"},variant:{default:"outline"},disabled:{type:Boolean,default:!1},error:{default:null},required:{type:Boolean,default:!1},formWrapperWidth:{default:"fit-content"}},emits:["update:modelValue"],setup(e,{emit:r}){const a=e,z=r,l=o(Array(a.length).fill("")),c=o([]);I(()=>a.modelValue,t=>{if(!t){l.value=Array(a.length).fill("");return}const i=t.split("").slice(0,a.length);for(;i.length<a.length;)i.push("");l.value=i},{immediate:!0}),I(l,()=>{z("update:modelValue",l.value.join(""))},{deep:!0});function D(t,i){const n=i.target.value.replace(/\D/g,"");l.value[t]=n,n&&t<a.length-1&&F(()=>c.value[t+1]?.focus())}function q(t){!l.value[t]&&t>0&&F(()=>c.value[t-1]?.focus())}function w(t){t.preventDefault();const u=(t.clipboardData?.getData("text")||"").replace(/\D/g,"").slice(0,a.length).split("");if(u.length!==0){u.forEach((n,s)=>{l.value[s]=n});for(let n=u.length;n<a.length;n++)l.value[n]="";F(()=>{const n=Math.min(u.length-1,a.length-1);c.value[n]?.focus()})}}return(t,i)=>(m(),d("div",{class:"fu-input-wrapper",style:T({width:e.formWrapperWidth})},[e.label?(m(),d("label",M,[k(V(e.label)+" ",1),e.required?(m(),d("span",U,"*")):C("",!0)])):C("",!0),W("div",{class:N(["fu-code-container",[`fu-input--${e.size}`,`fu-input--${e.variant}`,{"fu-input--error":e.error}]])},[(m(!0),d(B,null,E(l.value,(u,n)=>P((m(),d("input",{key:n,ref_for:!0,ref:s=>c.value[n]=s,type:"text",maxlength:"1",inputmode:"numeric",pattern:"[0-9]*",class:"fu-code-box fu-input-container","onUpdate:modelValue":s=>l.value[n]=s,onInput:s=>D(n,s),onKeydown:A(s=>q(n),["backspace"]),onPaste:w,disabled:e.disabled},null,40,_)),[[O,l.value[n]]])),128))],2),e.error?(m(),d("span",L,V(e.error),1)):C("",!0)],4))}}),y=K(x,[["__scopeId","data-v-aa788ef2"]]);x.__docgenInfo={exportName:"default",displayName:"FusionCodeInput",description:"",tags:{},props:[{name:"modelValue",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"label",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"length",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"6"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}},{name:"variant",required:!1,type:{name:"union",elements:[{name:'"outline"'},{name:'"subtle"'},{name:'"plain"'}]},defaultValue:{func:!1,value:'"outline"'}},{name:"disabled",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"error",required:!1,type:{name:"union",elements:[{name:"string"},{name:"null"}]},defaultValue:{func:!1,value:"null"}},{name:"required",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"formWrapperWidth",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'"fit-content"'}}],events:[{name:"update:modelValue",type:{names:["string"]}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/codeInput/FusionCodeInput.vue"]};const H={title:"Fusion/Forms/Text/FusionCodeInput",component:y,tags:["autodocs"],parameters:{docs:{description:{component:`
