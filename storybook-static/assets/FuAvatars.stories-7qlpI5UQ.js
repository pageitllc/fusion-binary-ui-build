import{d as A,b as c,F as y,e as F,u as S,j as x,t as U,i as h,o as r,f as D,r as w}from"./iframe-D3vfv6YP.js";import{F as e,U as k}from"./FuAvatar-z2FOHrlT.js";import{_ as z}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const p=A({__name:"FuAvatarGroup",props:{users:{},max:{},size:{}},emits:["click"],setup(a){const t=a,l=t.max??3,g=t.users.slice(0,l),d=t.users.length-l;return(b,v)=>(r(),c("div",{class:"fu-avatar-group",onClick:v[0]||(v[0]=s=>b.$emit("click"))},[(r(!0),c(y,null,F(S(g),(s,f)=>(r(),D(e,{key:s.id||f,src:s.src,name:s.name,alt:s.alt,size:a.size},null,8,["src","name","alt","size"]))),128)),d>0?(r(),c("div",{key:0,class:x(["fu-avatar fu-avatar--more",`fu-avatar--${a.size}`])}," +"+U(d),2)):h("",!0)]))}}),C=z(p,[["__scopeId","data-v-d339fd2f"]]);p.__docgenInfo={exportName:"default",displayName:"FuAvatarGroup",description:"",tags:{},props:[{name:"users",required:!0,type:{name:"Array",elements:[{name:"User"}]}},{name:"max",required:!1,type:{name:"number"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"xs"'},{name:'"sm"'},{name:'"md"'},{name:'"lg"'},{name:'"xl"'},{name:'"2xl"'},{name:'"3xl"'}]}}],events:[{name:"click"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/avatar/FuAvatarGroup.vue"]};const O={title:"Components/Avatar",component:e,tags:["autodocs"],parameters:{docs:{description:{component:`
