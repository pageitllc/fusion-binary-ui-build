import{d as M,x as V,k as y,f as B,b as F,g as c,t as k,l as w,u as x,A as b,i as g,j as _,m as z,T as E,o as p,q as S,r as d}from"./iframe-DQPhCJt3.js";import{F as C}from"./FusionActionButton-BLz_V-Vj.js";import{F as m}from"./FusionButton-BZkn3sOM.js";import{X as T}from"./x-DFlIIf-v.js";import{_ as O}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";import"./createLucideIcon-D8o8pLjL.js";const D={class:"fu-modal__header"},N={class:"fu-modal__title"},q={class:"fu-modal__body"},L={key:0,class:"fu-modal__footer"},h=M({__name:"FusionModal",props:{isVisible:{type:Boolean},title:{},size:{default:"md"},showFooter:{type:Boolean,default:!0},fixedHeight:{type:Boolean}},emits:["close","cancel","confirm"],setup(o,{emit:e}){const s=e,n=()=>s("close");function f(t){(t.key==="Escape"||t.key==="Esc")&&n()}return V(()=>{window.addEventListener("keydown",f)}),y(()=>{window.removeEventListener("keydown",f)}),(t,v)=>(p(),B(E,{to:"body"},[o.isVisible?(p(),F("div",{key:0,class:"fu-modal__backdrop",onClick:z(n,["self"])},[c("div",{class:_(["fu-modal",[`fu-modal--${o.size}`,{"fu-modal--fixed-height":o.fixedHeight}]])},[c("div",D,[c("h3",N,k(o.title),1),w(C,{text:" ",icon:x(T),class:"fu-modal__close",onClick:n,variant:"ghost",size:"sm"},null,8,["icon"])]),c("div",q,[b(t.$slots,"default",{},()=>[v[0]||(v[0]=S(" Default modal content. ",-1))],!0)]),o.showFooter?(p(),F("div",L,[b(t.$slots,"footer",{},void 0,!0)])):g("",!0)],2)])):g("",!0)]))}}),u=O(h,[["__scopeId","data-v-9804bf15"]]);h.__docgenInfo={exportName:"default",displayName:"FusionModal",description:"",tags:{},props:[{name:"isVisible",required:!0,type:{name:"boolean"}},{name:"title",required:!0,type:{name:"string"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}},{name:"showFooter",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"fixedHeight",required:!1,type:{name:"boolean"}}],events:[{name:"close"},{name:"cancel"},{name:"confirm"}],slots:[{name:"default"},{name:"footer"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/modal/FusionModal.vue"]};const R={title:"Fusion/Overlays/FusionModal",component:u,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],description:"Sets the modal width (small, medium, or large)."},showFooter:{control:"boolean",description:"Toggles visibility of the footer section.",table:{defaultValue:{summary:"true"}}},title:{control:"text",description:"Sets the modal header title."}},parameters:{docs:{description:{component:`
