import{s as w,m as h,q as f,o as F,d as g,a as y,f as P,g as o,x as i,T as B,j as p,b as V,r as m}from"./iframe-BeZJQ65s.js";import{F as l}from"./FusionButton-DmtKrqn1.js";import{_}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const M={key:0,class:"fu-preview-backdrop"},k={class:"fu-preview-modal"},x={class:"fu-preview-header"},S={class:"fu-preview-header__left"},C={class:"fu-preview-header__right"},T={class:"fu-preview-subheader"},E={class:"fu-preview-body"},v=w({__name:"FusionPreviewModal",props:{isVisible:{type:Boolean}},emits:["close"],setup(e,{emit:a}){const r=e,b=a,u=()=>b("close");h(()=>r.isVisible,s=>{document.body.style.overflow=s?"hidden":""},{immediate:!0});function c(s){s.key==="Escape"&&u()}return f(()=>{window.addEventListener("keydown",c)}),F(()=>{window.removeEventListener("keydown",c),document.body.style.overflow=""}),(s,N)=>(p(),g(B,{to:"body"},[e.isVisible?(p(),y("div",M,[o("div",k,[o("header",x,[o("div",S,[i(s.$slots,"header-left",{},void 0,!0)]),o("div",C,[i(s.$slots,"header-right",{},()=>[V(l,{variant:"subtle",size:"sm",text:"Close preview",onClick:u})],!0)])]),o("header",T,[i(s.$slots,"subheader",{},void 0,!0)]),o("main",E,[i(s.$slots,"default",{},void 0,!0)])])])):P("",!0)]))}}),d=_(v,[["__scopeId","data-v-fa20d496"]]);v.__docgenInfo={exportName:"default",displayName:"FusionPreviewModal",description:"",tags:{},props:[{name:"isVisible",required:!0,type:{name:"boolean"}}],events:[{name:"close"}],slots:[{name:"header-left"},{name:"header-right"},{name:"subheader"},{name:"default"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/modal/FusionPreviewModal.vue"]};const j={title:"Components/PreviewModal",component:d,tags:["autodocs"],argTypes:{isVisible:{control:"boolean",description:"Controls visibility of the preview modal."}},parameters:{docs:{description:{component:`
