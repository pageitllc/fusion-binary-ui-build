import{s as k,c as p,a as d,g as t,d as u,u as h,t as o,b as y,p as S,j as m}from"./iframe-BeZJQ65s.js";import{F as U}from"./FuAvatar-tORvbocF.js";import{c as C}from"./createLucideIcon-7ncFRN9y.js";import{F}from"./file-text-FPFYOJnp.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=C("video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]),B={class:"fu-attachment-left flex flex--gap-md flex--align-center"},b={class:"fu-attachment-preview"},_=["src","alt"],M={class:"fu-attachment-info flex flex--column"},E={class:"fu-attachment-title"},D={class:"fu-attachment-meta"},O={class:"fu-attachment-right flex flex--column flex--align-center flex--gap-md"},K={class:"fu-attachment-time"},f=k({__name:"FusionAttachment",props:{id:{},fileName:{},fileUrl:{},fileSize:{default:""},timestamp:{},userName:{},userAvatar:{default:null}},emits:["click"],setup(e,{emit:g}){const c=e,A=g;function l(){A("click",c.id)}const x=p(()=>/\.(png|jpe?g|gif|webp|svg)$/i.test(c.fileName)),N=p(()=>/\.(mp4|mov|avi|webm)$/i.test(c.fileName));return(V,j)=>(m(),d("div",{class:"fu-attachment-item",role:"button",tabindex:"0",onClick:l,onKeypress:S(l,["enter"])},[t("div",B,[t("div",b,[x.value?(m(),d("img",{key:0,src:e.fileUrl,alt:e.fileName,class:"fu-attachment-thumbnail"},null,8,_)):N.value?(m(),u(h(z),{key:1,class:"fu-attachment-icon",size:20})):(m(),u(h(F),{key:2,class:"fu-attachment-icon",size:20}))]),t("div",M,[t("span",E,o(e.fileName),1),t("span",D,o(e.fileSize),1)])]),t("div",O,[y(U,{src:e.userAvatar||void 0,name:e.userName,alt:e.userName,size:"xs","show-status":!1},null,8,["src","name","alt"]),t("span",K,o(e.timestamp),1)])],32))}}),v=w(f,[["__scopeId","data-v-3301bbcd"]]);f.__docgenInfo={exportName:"default",displayName:"FusionAttachment",description:"",tags:{},props:[{name:"id",required:!0,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"fileName",required:!0,type:{name:"string"}},{name:"fileUrl",required:!0,type:{name:"string"}},{name:"fileSize",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"timestamp",required:!0,type:{name:"string"}},{name:"userName",required:!0,type:{name:"string"}},{name:"userAvatar",required:!1,type:{name:"union",elements:[{name:"string"},{name:"null"}]},defaultValue:{func:!1,value:"null"}}],events:[{name:"click",type:{names:["union"],elements:[{name:"string"},{name:"number"}]}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/items/attachments/FusionAttachment.vue"]};const J={title:"Components/FusionAttachment",component:v,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...r.parameters?.docs?.source},description:{story:"Multiple Attachments Example",...r.parameters?.docs?.description}}};const W=["ImageAttachment","DocumentAttachment","VideoAttachment","ClickableAttachment","AttachmentList"];export{r as AttachmentList,s as ClickableAttachment,i as DocumentAttachment,a as ImageAttachment,n as VideoAttachment,W as __namedExportsOrder,J as default};
