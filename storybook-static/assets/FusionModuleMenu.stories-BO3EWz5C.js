import{s as b,a as r,g as u,f as d,F as y,h as g,M as v,j as o,l as k,b as f,w as M,d as C,v as x,t as _}from"./iframe-4anGkjM3.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{c}from"./createLucideIcon-MAVkZFkt.js";import{C as e}from"./calendar-BhX05SNM.js";import"./preload-helper-Ct5FWWRu.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B=c("layout-dashboard",[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]]);/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=c("list-todo",[["path",{d:"M13 5h8",key:"a7qcls"}],["path",{d:"M13 12h8",key:"h98zly"}],["path",{d:"M13 19h8",key:"c3s6r1"}],["path",{d:"m3 17 2 2 4-4",key:"1jhpwq"}],["rect",{x:"3",y:"4",width:"6",height:"6",rx:"1",key:"cif1o7"}]]),P={class:"fu-module-menu-wrapper scrollbar__control customScrollBar"},D={class:"fu-module-menu-wrapper__list"},S={key:0,class:"fu-module-menu-empty"},p=b({__name:"FusionModuleMenu",props:{items:{},activePath:{}},setup(s){return(L,T)=>{const m=v("router-link");return o(),r("div",P,[u("ul",D,[(o(!0),r(y,null,g(s.items,t=>(o(),r("li",{key:t.path,class:k({active:s.activePath&&s.activePath.startsWith(t.path)})},[f(m,{class:"fu-module-menu-link",to:t.path},{default:M(()=>[t.icon?(o(),C(x(t.icon),{key:0,size:15,class:"fu-module-menu-icon"})):d("",!0),u("span",null,_(t.label),1)]),_:2},1032,["to"])],2))),128)),!s.items||!s.items.length?(o(),r("li",S," No menu items ")):d("",!0)])])}}}),q=w(p,[["__scopeId","data-v-7631f4b6"]]);p.__docgenInfo={exportName:"default",displayName:"FusionModuleMenu",description:"",tags:{},props:[{name:"items",required:!0,type:{name:"Array",elements:[{name:"MenuItem"}]}},{name:"activePath",required:!1,type:{name:"string"}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/modulemenu/FusionModuleMenu.vue"]};const R={title:"Components/ModuleMenu",component:q,tags:["autodocs"],parameters:{docs:{description:{component:`
### **FusionModuleMenu**
