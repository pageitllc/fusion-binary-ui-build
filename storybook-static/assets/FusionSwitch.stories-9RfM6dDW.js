import{d as p,D as v,c as b,b as f,n as g,o as h,r as n}from"./iframe-o7SUGoga.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const S=["aria-checked","disabled"],r=p({__name:"FusionSwitch",props:{modelValue:{type:Boolean},disabled:{type:Boolean},size:{}},emits:["update:modelValue"],setup(e,{emit:s}){const a=e,t=s;function m(){a.disabled||t("update:modelValue",!a.modelValue)}const u=v(()=>{switch(a.size){case"sm":return"fu-switch--sm";case"lg":return"fu-switch--lg";default:return"fu-switch--md"}});return(x,c)=>(h(),b("button",{type:"button",class:g(["fu-switch",[{"fu-switch--checked":e.modelValue,disabled:e.disabled},u.value]]),role:"switch","aria-checked":e.modelValue,disabled:e.disabled,onClick:m},[...c[0]||(c[0]=[f("span",{class:"fu-switch__thumb"},null,-1)])],10,S))}}),d=w(r,[["__scopeId","data-v-c8285d1a"]]);r.__docgenInfo={exportName:"default",displayName:"FusionSwitch",description:"",tags:{},props:[{name:"modelValue",required:!0,type:{name:"boolean"}},{name:"disabled",required:!1,type:{name:"boolean"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]}}],events:[{name:"update:modelValue",type:{names:["boolean"]}}],sourceFiles:["/Users/tommys/Documents/Skkido/Fusion-binary-ui/src/components/switch/FusionSwitch.vue"]};const V={title:"UI/FusionSwitch",component:d,tags:["autodocs"],parameters:{docs:{description:{component:`
