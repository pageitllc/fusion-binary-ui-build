import{d as y,D as f,c as o,b as a,a as x,h as F,F as k,s as w,o as p,n as P,t as S,r as v}from"./iframe-o7SUGoga.js";import{_}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const T={class:"fu-progress-stepper"},A={class:"fu-progress-bar"},B={key:0,class:"fu-step-labels"},L=["onClick"],C={class:"circle"},D={class:"label"},b=y({__name:"FusionProgressStepper",props:{currentStep:{},totalSteps:{},showLabels:{type:Boolean},steps:{}},emits:["step-click"],setup(e,{emit:t}){const s=e,n=t,m=f(()=>`${(s.currentStep+1)/s.totalSteps*100}%`),d=g=>n("step-click",g);return(g,N)=>(p(),o("div",T,[a("div",A,[a("div",{class:"fu-progress-fill",style:F({width:m.value})},null,4)]),e.showLabels&&e.steps?(p(),o("div",B,[(p(!0),o(k,null,w(e.steps,(h,r)=>(p(),o("div",{key:r,class:P(["fu-step-label",{active:e.currentStep===r}]),onClick:z=>d(r)},[a("div",C,S(r+1),1),a("div",D,S(h.title),1)],10,L))),128))])):x("",!0)]))}}),u=_(b,[["__scopeId","data-v-6ac0e869"]]);b.__docgenInfo={exportName:"default",displayName:"FusionProgressStepper",description:"",tags:{},props:[{name:"currentStep",required:!0,type:{name:"number"}},{name:"totalSteps",required:!0,type:{name:"number"}},{name:"showLabels",required:!1,type:{name:"boolean"}},{name:"steps",required:!1,type:{name:"Array",elements:[{name:"{ title: string }"}]}}],events:[{name:"step-click"}],sourceFiles:["/Users/tommys/Documents/Skkido/Fusion-binary-ui/src/components/progress/FusionProgressStepper.vue"]};const E={title:"Components/FusionProgressStepper",component:u,tags:["autodocs"],parameters:{docs:{description:{component:`
