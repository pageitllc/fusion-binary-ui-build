import{F as l}from"./FusionCheckbox-a53pfdqT.js";import"./iframe-BeZJQ65s.js";import"./preload-helper-Ct5FWWRu.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const m={title:"Components/Checkbox",component:l,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md"],description:"Controls the size of the checkbox"},label:{control:"text",description:"Optional label displayed next to the checkbox"},modelValue:{control:"boolean",description:"v-model binding for checked state"},disabled:{control:"boolean",description:"Disables the checkbox"},id:{control:"text",description:"ID for the checkbox (used to bind <label> to <input>)"}},parameters:{docs:{description:{component:`
