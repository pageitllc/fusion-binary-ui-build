import{d as K,r as n,x as U,k as V,b,g as q,A as k,f as J,l as X,w as G,z as Y,T as Q,F as Z,p as A,o as h,m as ee,n as te,j as M,u as N,i as E,c as D}from"./iframe-DQPhCJt3.js";import{_ as oe}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{F as v}from"./FusionButton-BZkn3sOM.js";import{F as re}from"./FusionTextInput-BE2hkcFJ.js";import"./preload-helper-Ct5FWWRu.js";const ne={class:"fu-popover__body customScrollBar"},W=K({__name:"FuPopover",props:{align:{},side:{},offset:{},width:{},maxHeight:{},stickyHeader:{type:Boolean},stickyFooter:{type:Boolean}},emits:["open","close"],setup(r,{expose:s,emit:a}){const t=r,p=a,d=n(!1),c=n(null),u=n(null),y=n({position:"fixed",visibility:"hidden",top:"-9999px",left:"-9999px",zIndex:9999}),P=t.stickyHeader??!1,z=t.stickyFooter??!1;function I(){d.value?l():i()}function i(){y.value={position:"fixed",visibility:"hidden",top:"-9999px",left:"-9999px",width:t.width??"auto",zIndex:9999,maxHeight:t.maxHeight??"none"},d.value=!0,p("open"),A(()=>requestAnimationFrame(()=>requestAnimationFrame(()=>{g(),A(()=>{const e=u.value?.querySelector("input, textarea");e&&e.focus()})})))}function l(){d.value=!1,p("close")}function g(){if(!c.value||!u.value)return;const e=c.value.getBoundingClientRect(),o=u.value.getBoundingClientRect(),f=8,L=t.offset??6,T=window.innerHeight-e.bottom-f,C=e.top-f;let x=t.side??"bottom";x==="bottom"&&o.height>T&&C>T?x="top":x==="top"&&o.height>C&&T>C&&(x="bottom");let R=x==="top"?e.top-o.height-L:e.bottom+L,_=t.align==="right"?e.right-o.width:t.align==="center"?e.left+e.width/2-o.width/2:e.left;_=Math.max(f,Math.min(_,window.innerWidth-o.width-f)),R=Math.max(f,Math.min(R,window.innerHeight-o.height-f)),y.value={position:"fixed",top:`${R}px`,left:`${_}px`,width:t.width??"auto",maxHeight:t.maxHeight??"none",zIndex:9999,visibility:"visible"}}function O(e){if(!d.value)return;const o=e.target;c.value?.contains(o)||u.value?.contains(o)||o instanceof Element&&o.closest(".fu-popover, .fu-popover-wrap")||l()}return U(()=>{window.addEventListener("mousedown",O),window.addEventListener("resize",g),window.addEventListener("scroll",g,!0)}),V(()=>{window.removeEventListener("mousedown",O),window.removeEventListener("resize",g),window.removeEventListener("scroll",g,!0)}),s({open:i,close:l}),(e,o)=>(h(),b(Z,null,[q("div",{ref_key:"triggerRef",ref:c,class:"fu-popover-wrap",onClick:I},[k(e.$slots,"trigger",{},void 0,!0)],512),(h(),J(Q,{to:"body"},[X(Y,{name:"fu-popover"},{default:G(()=>[d.value?(h(),b("div",{key:0,ref_key:"popoverRef",ref:u,class:"fu-popover",style:te(y.value),tabindex:"-1",onClick:o[0]||(o[0]=ee(()=>{},["stop"]))},[e.$slots.header?(h(),b("div",{key:0,class:M(["fu-popover__header",{"is-sticky":N(P)}])},[k(e.$slots,"header",{},void 0,!0)],2)):E("",!0),q("div",ne,[k(e.$slots,"default",{},void 0,!0)]),e.$slots.footer?(h(),b("div",{key:1,class:M(["fu-popover__footer",{"is-sticky":N(z)}])},[k(e.$slots,"footer",{},void 0,!0)],2)):E("",!0)],4)):E("",!0)]),_:3})]))],64))}}),m=oe(W,[["__scopeId","data-v-ff9bba0a"]]);W.__docgenInfo={exportName:"default",displayName:"FuPopover",description:"",tags:{},expose:[{name:"open"},{name:"close"}],props:[{name:"align",required:!1,type:{name:"FuPopoverAlign"}},{name:"side",required:!1,type:{name:"FuPopoverSide"}},{name:"offset",required:!1,type:{name:"number"}},{name:"width",required:!1,type:{name:"string"}},{name:"maxHeight",required:!1,type:{name:"string"}},{name:"stickyHeader",required:!1,type:{name:"boolean"}},{name:"stickyFooter",required:!1,type:{name:"boolean"}}],events:[{name:"open"},{name:"close"}],slots:[{name:"trigger"},{name:"header"},{name:"default"},{name:"footer"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/popover/FuPopover.vue"]};const ue={title:"Fusion/Overlays/FuPopover",component:m,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"\n**FuPopover** is a generic, unstyled popover wrapper from the Fusion Binary design system.\n\nIt handles positioning, flipping, outside-click closing, and scroll containment. You control the content entirely.\n\n---\n\n### How it works\n\n- `#trigger` → clickable element that opens/closes the popover\n- `#header` → optional — sticky or scrollable depending on `stickyHeader`\n- **default slot** → the scrollable body, always scrolls when `maxHeight` is set\n- `#footer` → optional — sticky or scrollable depending on `stickyFooter`\n- Teleported to `<body>` — never clipped by ancestors\n- Auto-flips vertically if there is not enough room\n\n---\n\n### Sticky behavior\n\n| Prop | Value | Behavior |\n|------|-------|----------|\n| `stickyHeader` | `true` | Header pins to top while body scrolls |\n| `stickyHeader` | `false` | Header scrolls away with content |\n| `stickyFooter` | `true` | Footer pins to bottom while body scrolls |\n| `stickyFooter` | `false` | Footer scrolls away with content |\n\n---\n\n### Props\n\n| Prop | Type | Default | Description |\n|------|------|---------|-------------|\n| `align` | `'left' \\| 'right' \\| 'center'` | `'left'` | Horizontal alignment |\n| `side` | `'bottom' \\| 'top'` | `'bottom'` | Opening side — auto-flips |\n| `offset` | `number` | `6` | Gap between trigger and popover |\n| `width` | `string` | `'auto'` | CSS width |\n| `maxHeight` | `string` | `'none'` | Caps the body scroll area |\n| `stickyHeader` | `boolean` | `false` | Pin header to top |\n| `stickyFooter` | `boolean` | `false` | Pin footer to bottom |\n\n### Slots\n\n| Slot | Description |\n|------|-------------|\n| `#trigger` | Opens/closes the popover |\n| `#header` | Optional top area |\n| `default` | Scrollable body |\n| `#footer` | Optional bottom area |\n\n### Emits\n\n| Event | When |\n|-------|------|\n| `open` | Popover opens |\n| `close` | Popover closes |\n\n### Exposed\n\n| Method | Description |\n|--------|-------------|\n| `open()` | Open programmatically |\n| `close()` | Close programmatically |\n\n---\n\n### ⚠️ Key rule\n\n> **The popover owns the scroll. Never put `overflow` or `max-height` on your content.**\n> Set `maxHeight` on `<FuPopover>` and let `.fu-popover__body` handle it.\n\n---\n        "}}},argTypes:{align:{control:"select",options:["left","right","center"]},side:{control:"select",options:["bottom","top"]},offset:{control:"number"},width:{control:"text"},maxHeight:{control:"text"},stickyHeader:{control:"boolean"},stickyFooter:{control:"boolean"}}},F={render:r=>({components:{FuPopover:m,FuButton:v},setup(){return{args:r}},template:`
    ...
    `}),args:{width:"220px"},parameters:{docs:{description:{story:"Minimal usage — trigger + body only. No `maxHeight` so body expands to fit."}}}},w={render:r=>({components:{FuPopover:m,FuButton:v},setup(){const s=Array.from({length:30},(a,t)=>`Item ${t+1}`);return{args:r,items:s}},template:`
      <FuPopover v-bind="args">
        <template #trigger>
