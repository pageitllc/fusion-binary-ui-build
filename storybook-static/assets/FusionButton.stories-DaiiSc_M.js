import{F as d}from"./FusionButton-DRIYy3ox.js";import{C as p}from"./check-DHMP4OBX.js";import"./iframe-LVkgWH8l.js";import"./preload-helper-Ct5FWWRu.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./createLucideIcon-BmHTr6Hj.js";const b={title:"Components/Button",component:d,tags:["autodocs"],argTypes:{text:{control:"text",description:"Button text (used when no default slot is provided)."},size:{control:"select",options:["sm","md","lg"],description:"Button size."},variant:{control:"select",options:["solid","subtle","outline","ghost","danger"],description:"Visual style of the button."},disabled:{control:"boolean",description:"Disables the button."},loading:{control:"boolean",description:"Shows a loading spinner and disables interaction."},loadingText:{control:"text",description:"Text displayed when loading is true."},tooltip:{control:"text",description:"Tooltip shown on hover."},icon:{control:"text",description:"Icon component to render before the text."},link:{control:"text",description:"If set, renders the button as an anchor tag."},target:{control:"select",options:["_parent","_blank"],description:"Target used when link is set."},buttonWidth:{control:"text",description:"Sets the width of the button wrapper. Accepts values like `100%`, `200px`, `fit-content`, etc.",table:{defaultValue:{summary:'""'}}},onClick:{action:"clicked",description:"Emitted when the button is clicked."}},parameters:{docs:{description:{component:`
