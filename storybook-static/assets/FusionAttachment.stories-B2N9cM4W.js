import{d as C,c as g,b as m,g as t,f as v,u as p,t as d,l as u,m as w,w as b,i as U,v as D,o as a}from"./iframe-D33anl-W.js";import{F as E}from"./FuAvatar-iBKHnci-.js";import{D as F}from"./DropdownMenu-FW9YH_N7.js";import{F as z}from"./FusionActionButton-CzHwIieA.js";import{V as B}from"./video-BXw9nUIJ.js";import{F as O}from"./file-text-CaHZCXlH.js";import{E as _}from"./ellipsis-vertical-CWiVrZnF.js";import{_ as M}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{S as V}from"./square-pen-BGFcDftj.js";import{T as q}from"./trash-2-Bnm-U-JF.js";import{S as T}from"./share-2-K27DuGx8.js";import"./preload-helper-Ct5FWWRu.js";import"./createLucideIcon-DaJMaH6u.js";const I={class:"fu-attachment-left flex flex--gap-md flex--align-center"},K={class:"fu-attachment-preview"},P=["src","alt"],R={class:"fu-attachment-info flex flex--column"},j={class:"fu-attachment-title"},W={class:"fu-attachment-meta"},L={class:"fu-attachment-right flex flex--align-center flex--gap-md"},J={class:"flex flex--column flex--align-center"},$={class:"fu-attachment-time"},A=C({__name:"FusionAttachment",props:{id:{},fileName:{},fileUrl:{},fileSize:{default:""},timestamp:{},userName:{},userAvatar:{default:null},actions:{default:()=>[]}},emits:["click"],setup(e,{emit:x}){const l=e,N=x;function h(){N("click",l.id)}const S=g(()=>/\.(png|jpe?g|gif|webp|svg)$/i.test(l.fileName)),y=g(()=>/\.(mp4|mov|avi|webm)$/i.test(l.fileName));return(H,f)=>(a(),m("div",{class:"fu-attachment-item",role:"button",tabindex:"0",onClick:h,onKeypress:D(h,["enter"])},[t("div",I,[t("div",K,[S.value?(a(),m("img",{key:0,src:e.fileUrl,alt:e.fileName,class:"fu-attachment-thumbnail"},null,8,P)):y.value?(a(),v(p(B),{key:1,class:"fu-attachment-icon",size:20})):(a(),v(p(O),{key:2,class:"fu-attachment-icon",size:20}))]),t("div",R,[t("span",j,d(e.fileName),1),t("span",W,d(e.fileSize),1)])]),t("div",L,[t("div",J,[u(E,{src:e.userAvatar||void 0,name:e.userName,alt:e.userName,size:"xs","show-status":!1},null,8,["src","name","alt"]),t("span",$,d(e.timestamp),1)]),e.actions?.length?(a(),m("div",{key:0,class:"fu-attachment-actions",onClick:f[0]||(f[0]=w(()=>{},["stop"]))},[u(F,{actions:e.actions,align:"right"},{trigger:b(()=>[u(z,{icon:p(_),variant:"ghost",size:"sm"},null,8,["icon"])]),_:1},8,["actions"])])):U("",!0)])],32))}}),k=M(A,[["__scopeId","data-v-c5d821de"]]);A.__docgenInfo={exportName:"default",displayName:"FusionAttachment",description:"",tags:{},props:[{name:"id",required:!0,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"fileName",required:!0,type:{name:"string"}},{name:"fileUrl",required:!0,type:{name:"string"}},{name:"fileSize",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"timestamp",required:!0,type:{name:"string"}},{name:"userName",required:!0,type:{name:"string"}},{name:"userAvatar",required:!1,type:{name:"union",elements:[{name:"string"},{name:"null"}]},defaultValue:{func:!1,value:"null"}},{name:"actions",required:!1,type:{name:"Array",elements:[{name:"Action"}]},defaultValue:{func:!1,value:"() => []"}}],events:[{name:"click",type:{names:["union"],elements:[{name:"string"},{name:"number"}]}}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/items/attachments/FusionAttachment.vue"]};const re={title:"Components/FusionAttachment",component:k,tags:["autodocs"],parameters:{docs:{description:{component:`
