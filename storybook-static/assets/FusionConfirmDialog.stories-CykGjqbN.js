import{d as B,c as V,x,k as _,f as h,b as L,g as s,y as q,t as c,l as D,w as y,j as A,m as O,i as W,T as E,o as b,q as F,r as t}from"./iframe-D3vfv6YP.js";import{F as a}from"./FusionButton-BKxkbJgK.js";import{T as N}from"./trash-2-C5ao0WNe.js";import{c as S}from"./createLucideIcon-DKFlsGA7.js";import{C as P}from"./circle-check-big-zFgBy0I7.js";import{_ as I}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=S("triangle-alert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]),U={class:"fu-confirm__body"},z={class:"fu-confirm__icon"},j={class:"fu-confirm__title"},Y={class:"fu-confirm__message"},K={class:"fu-confirm__footer"},k=B({__name:"FusionConfirmDialog",props:{isVisible:{type:Boolean},title:{},message:{},variant:{default:"confirm"},confirmText:{default:"Confirm"},cancelText:{default:"Cancel"},loading:{type:Boolean,default:!1}},emits:["cancel","confirm"],setup(e,{emit:n}){const o=e,i=n,g=()=>{o.loading||i("cancel")},p=()=>{o.loading||i("confirm")},v=()=>{o.loading||i("cancel")},T=V(()=>o.variant==="delete"?N:o.variant==="warning"?M:P),w=V(()=>o.variant==="delete"||o.variant==="warning"?"danger":"solid"),C=l=>{o.isVisible&&(o.loading||(l.key==="Enter"&&(l.preventDefault(),p()),l.key==="Escape"&&g()))};return x(()=>{window.addEventListener("keydown",C)}),_(()=>{window.removeEventListener("keydown",C)}),(l,R)=>(b(),h(E,{to:"body"},[e.isVisible?(b(),L("div",{key:0,class:"fu-modal__backdrop",onClick:O(v,["self"])},[s("div",{class:A(["fu-confirm",`fu-confirm--${e.variant}`])},[s("div",U,[s("div",z,[(b(),h(q(T.value)))]),s("h3",j,c(e.title),1),s("p",Y,c(e.message),1)]),s("div",K,[D(a,{variant:"outline",buttonWidth:"100%",disabled:e.loading,onClick:g},{default:y(()=>[F(c(e.cancelText),1)]),_:1},8,["disabled"]),D(a,{variant:w.value,buttonWidth:"100%",loading:e.loading,disabled:e.loading,onClick:p},{default:y(()=>[F(c(e.confirmText),1)]),_:1},8,["variant","loading","disabled"])])],2)])):W("",!0)]))}}),r=I(k,[["__scopeId","data-v-094e1d3b"]]);k.__docgenInfo={exportName:"default",displayName:"FusionConfirmDialog",description:"",tags:{},props:[{name:"isVisible",required:!0,type:{name:"boolean"}},{name:"title",required:!0,type:{name:"string"}},{name:"message",required:!0,type:{name:"string"}},{name:"variant",required:!1,type:{name:"union",elements:[{name:'"delete"'},{name:'"warning"'},{name:'"confirm"'}]},defaultValue:{func:!1,value:'"confirm"'}},{name:"confirmText",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'"Confirm"'}},{name:"cancelText",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'"Cancel"'}},{name:"loading",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],events:[{name:"cancel"},{name:"confirm"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/modal/FusionConfirmDialog.vue"]};const ee={title:"Components/Confirm Dialog",component:r,tags:["autodocs"],argTypes:{variant:{control:"select",options:["confirm","warning","delete"],description:"Defines the intent and visual style of the dialog."},title:{control:"text",description:"Primary confirmation title shown to the user."},message:{control:"text",description:"Supporting message explaining the impact of the action."},confirmText:{control:"text",description:"Label for the primary confirm button."}},parameters:{docs:{description:{component:`
