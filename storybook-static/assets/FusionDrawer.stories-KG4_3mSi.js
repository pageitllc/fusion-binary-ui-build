import{d as N,x as C,k as S,f as w,w as z,z as P,o as r,b as x,g as a,j as y,A as b,l as T,u as D,i as l,r as p,c as F}from"./iframe-DQPhCJt3.js";import{F as B}from"./FusionActionButton-BLz_V-Vj.js";import{X as O}from"./x-DFlIIf-v.js";import{C as E}from"./chevron-up-BwDthXdB.js";import{C as _}from"./chevron-down-CXcF9qSO.js";import{_ as $}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{F as h}from"./FusionButton-BZkn3sOM.js";import"./preload-helper-Ct5FWWRu.js";import"./createLucideIcon-D8o8pLjL.js";const q={key:0,class:"fu-drawer"},A={class:"fu-drawer__header-content"},L={key:0,class:"fu-drawer__header-actions"},V={class:"fu-drawer__body"},U={class:"fu-drawer__footer"},k=N({__name:"FusionDrawer",props:{open:{type:Boolean},title:{},position:{default:"right"},size:{default:"half"},showControls:{type:Boolean,default:!0},hideHeaderBorder:{type:Boolean,default:!1},canNext:{type:Boolean},canPrev:{type:Boolean}},emits:["close","next","prev"],setup(e,{emit:u}){const o=e,g=u;function s(n){n.key==="Escape"&&o.open&&g("close")}return C(()=>window.addEventListener("keydown",s)),S(()=>window.removeEventListener("keydown",s)),(n,t)=>(r(),w(P,{name:"drawer-fade"},{default:z(()=>[e.open?(r(),x("div",q,[a("div",{class:"fu-drawer__backdrop",onClick:t[0]||(t[0]=i=>n.$emit("close"))}),a("div",{class:y(["fu-drawer__panel",[`fu-drawer__panel--${e.position}`,`fu-drawer__panel--${e.size}`,{"fu-drawer__panel--with-controls":e.showControls}]])},[n.$slots.header||e.showControls?(r(),x("div",{key:0,class:y(["fu-drawer__header",{"border-bottom-0":e.hideHeaderBorder}])},[a("div",A,[b(n.$slots,"header",{},void 0,!0)]),e.showControls?(r(),x("div",L,[T(B,{size:"sm",variant:"subtle",icon:D(O),onClick:t[1]||(t[1]=i=>n.$emit("close"))},null,8,["icon"])])):l("",!0)],2)):l("",!0),a("div",V,[b(n.$slots,"default",{class:"slot-body"},void 0,!0)]),a("div",{class:y(["fu-drawer__nav",[e.position==="right"?"fu-drawer__nav--left":"",e.position==="left"?"fu-drawer__nav--right":"",e.position==="bottom"?"fu-drawer__nav--center":""]])},[e.canPrev?(r(),w(B,{key:0,size:"sm",variant:"subtle",icon:D(E),onClick:t[2]||(t[2]=i=>n.$emit("prev"))},null,8,["icon"])):l("",!0),e.canNext?(r(),w(B,{key:1,size:"sm",variant:"subtle",icon:D(_),onClick:t[3]||(t[3]=i=>n.$emit("next"))},null,8,["icon"])):l("",!0)],2),a("div",U,[b(n.$slots,"footer",{},void 0,!0)])],2)])):l("",!0)]),_:3}))}}),d=$(k,[["__scopeId","data-v-37927fd4"]]);k.__docgenInfo={exportName:"default",displayName:"FusionDrawer",description:"",tags:{},props:[{name:"open",required:!0,type:{name:"boolean"}},{name:"title",required:!1,type:{name:"string"}},{name:"position",required:!1,type:{name:"union",elements:[{name:'"left"'},{name:'"right"'},{name:'"bottom"'}]},defaultValue:{func:!1,value:'"right"'}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"half"'},{name:'"full"'}]},defaultValue:{func:!1,value:'"half"'}},{name:"showControls",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"hideHeaderBorder",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"canNext",required:!1,type:{name:"boolean"}},{name:"canPrev",required:!1,type:{name:"boolean"}}],events:[{name:"close"},{name:"prev"},{name:"next"}],slots:[{name:"header"},{name:"default",scoped:!0,bindings:[{name:"class",title:"binding"}]},{name:"footer"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/drawer/FusionDrawer.vue"]};const G={title:"Fusion/Overlays/FusionDrawer",component:d,tags:["autodocs"],argTypes:{open:{control:"boolean",description:"Controls drawer visibility."},title:{control:"text",description:"Drawer header title text."},position:{control:"select",options:["left","right","bottom"],description:"Sets the drawer position on screen."},size:{control:"select",options:["half","full"],description:"Sets the drawer size (half = 50%, full = 70%)."},showControls:{control:"boolean",description:"Toggles the header with navigation and close buttons."},canNext:{control:"boolean",description:"Enable the Next button."},canPrev:{control:"boolean",description:"Enable the Previous button."}},parameters:{docs:{description:{component:`
