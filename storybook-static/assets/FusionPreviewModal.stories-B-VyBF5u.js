import{d as h,s as f,x as F,k as g,f as y,b as P,g as o,A as i,i as B,T as V,o as m,l as k,r as v}from"./iframe-DQPhCJt3.js";import{F as r}from"./FusionButton-BZkn3sOM.js";import{_ as M}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-Ct5FWWRu.js";const _={key:0,class:"fu-preview-backdrop"},x={class:"fu-preview-modal"},S={class:"fu-preview-header"},T={class:"fu-preview-header__left"},C={class:"fu-preview-header__right"},E={class:"fu-preview-body"},b=h({__name:"FusionPreviewModal",props:{isVisible:{type:Boolean}},emits:["close"],setup(e,{emit:a}){const l=e,w=a,d=()=>w("close");f(()=>l.isVisible,s=>{document.body.style.overflow=s?"hidden":""},{immediate:!0});function c(s){s.key==="Escape"&&d()}return F(()=>{window.addEventListener("keydown",c)}),g(()=>{window.removeEventListener("keydown",c),document.body.style.overflow=""}),(s,p)=>(m(),y(V,{to:"body"},[e.isVisible?(m(),P("div",_,[o("div",x,[o("header",S,[o("div",T,[i(s.$slots,"header-left",{},void 0,!0)]),o("div",C,[i(s.$slots,"header-right",{},()=>[k(r,{variant:"subtle",size:"sm",text:"Close preview",onClick:d})],!0)])]),i(s.$slots,"subheader",{},()=>[p[0]||(p[0]=o("header",{class:"fu-preview-subheader"},null,-1))],!0),o("main",E,[i(s.$slots,"default",{},void 0,!0)])])])):B("",!0)]))}}),u=M(b,[["__scopeId","data-v-d53784c5"]]);b.__docgenInfo={exportName:"default",displayName:"FusionPreviewModal",description:"",tags:{},props:[{name:"isVisible",required:!0,type:{name:"boolean"}}],events:[{name:"close"}],slots:[{name:"header-left"},{name:"header-right"},{name:"subheader"},{name:"default"}],sourceFiles:["/Users/xavier/Documents/Websites/Skkido/Fusion-binary-ui/src/components/modal/FusionPreviewModal.vue"]};const A={title:"Fusion/Overlays/FusionPreviewModal",component:u,tags:["autodocs"],argTypes:{isVisible:{control:"boolean",description:"Controls visibility of the preview modal."}},parameters:{docs:{description:{component:`
