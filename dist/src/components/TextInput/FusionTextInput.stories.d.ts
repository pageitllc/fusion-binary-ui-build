...
export declare const TypeformVariant: Story;
export declare const TypeformCustomStyle: Story;
export declare const ReadOnly: Story;
export declare const SearchInput: Story;
export declare const SearchSubtle: Story;
export declare const WithLeftIcon: Story;
export declare const WithRightIcon: Story;
export declare const WithAvatar: Story;
export declare const MaskPhone: Story;
export declare const MaskCard: Story;
export declare const MaskCurrency: Story;
export declare const MaskCustom: Story;
export declare const AutoFocusExpose: Story;
