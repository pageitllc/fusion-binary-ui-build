...
class tw extends Ht {
  constructor(e) {
    super(e), this.dragSelection = null, this.handlePointerDown = (o) => {
      ...
      u.setIgnoreMove(!d), u.delay = o.isTouch ? nw(s) : null;
      ...
      if (o) {
        ...
        o.componentId === h.componentId && this.isHitComboAllowed && !this.isHitComboAllowed(h, o) || (c = aw(h, o, u.pluginHooks.dateSelectionTransformers)), (!c || !db(c, o.dateProfile, u)) && (d = !0, c = null);
      }
...
class en extends Ht {
  constructor(e) {
    super(e), this.subjectEl = null, this.subjectSeg = null, this.isDragging = !1, this.eventRange = null, this.relevantEvents = null, this.receivingContext = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = (o) => {
      ...
      o.isTouch && g !== u.props.eventSelection ? rw(u) : null, h.fixedMirrorParent ? d.parentNode = h.fixedMirrorParent : d.parentNode = ze(s, ".fc"), d.revertDuration = h.dragRevertDuration;
      ...
      if (o) {
        h = o.context;
        let b = h.options;
        d === h || b.editable && b.droppable ? (p = iw(c, o, this.eventRange.instance.range.start, h.getCurrentData().pluginHooks.eventDragMutationMassagers), p && (v = Ya(u, h.getCurrentData().eventUiBases, p, h), g.mutatedEvents = v, jo(g, o.dateProfile, h) || (y = !0, p = null, v = null, g.mutatedEvents = Ke()))) : h = null;
      }
...
class ow extends Ht {
  constructor(e) {
    super(e), this.draggingSegEl = null, this.draggingSeg = null, this.eventRange = null, this.relevantEvents = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = (r) => {
      ...
      r && (r.componentId === d.componentId && this.isHitComboAllowed && !this.isHitComboAllowed(d, r) || (p = sw(d, r, s.subjectEl.classList.contains("fc-event-resizer-start"), h.range))), p && (v = Ya(c, u.getCurrentData().eventUiBases, p, u), g.mutatedEvents = v, jo(g, r.dateProfile, u) || (y = !0, p = null, v = null, g.mutatedEvents = null)), v ? u.dispatch({
...
const hw = /^[A-Za-z_+-]{1,256}(:?\/[A-Za-z_+-]{1,256}(\/[A-Za-z_+-]{1,256})?)?$/, vw = {
  year: 0,
  month: 1,
  day: 2,
  hour: 3,
...
function yw(t, e) {
  ...
  for (let i = 0; i < n.length; i++) {
    const { type: r, value: o } = n[i], s = vw[r];
...
function ww(t) {
  ...
  const [a, i, r, o, s, u] = n.formatToParts ? yw(n, e) : gw(n, e), c = Cw({
    year: a,
    month: i,
    day: r,
    hour: o,
...
function Aw(t) {
  return fw.reduce(
    function(e, n) {
      ...
      return e.push({
        ...r,
        currentTimeFormat: mw(r, {
          useCurrentOffset: !0
        })
      }), e;
    },
    []
  ).sort((e, n) => _w(e, n) || cr(e.alternativeName, n.alternativeName) || cr(e.mainCities[0], n.mainCities[0]));
}
function _w(t, e) {
...
const Sw = ["data-widget-id"], kw = {
  key: 0,
  class: "fu-empty"
}, Tw = {
  key: 1,
  class: "fu-layout"
}, Ew = { class: "fu-info" }, Mw = { class: "fu-info__name" }, Nw = {
  key: 0,
  class: "fu-info__meta"
}, Dw = {
  key: 1,
  class: "fu-info__desc"
}, Iw = ["aria-expanded"], Ow = { class: "fu-tz__label" }, Rw = {
  key: 0,
  class: "fu-tz__dropdown"
}, xw = { class: "fu-tz__search-wrap" }, $w = { class: "fu-tz__search-icon" }, Pw = {
  key: 0,
  class: "fu-tz__no-results"
}, Fw = ["onMouseenter", "onMousedown"], Bw = { class: "fu-tz__opt-offset" }, zw = { class: "fu-tz__opt-name" }, Lw = { class: "fu-tz__opt-country" }, Hw = {
  key: 0,
  class: "fu-selected"
}, Vw = { class: "fu-selected__time" }, jw = { class: "fu-selected__time" }, Ww = { class: "fu-right" }, Uw = {
  key: 0,
  class: "fu-slots"
}, Yw = { class: "fu-slots__header" }, Gw = { class: "fu-slots__heading" }, Kw = {
  key: 0,
  ...
  setup(t, { emit: e }) {
    ...
    return (I, $) => (l(), f("div", {
      ...
      t.eventTypeId ? (l(), f("div", Tw, [
        m("div", Ew, [
          m("p", Mw, S(t.eventTypeName || "Event"), 1),
          t.timezone ? (l(), f("div", Nw, [
            $[6] || ($[6] = m("span", { class: "fu-info__icon" }, "🌐", -1)),
            m("span", null, S(t.timezone), 1)
          ])) : A("", !0),
          t.description ? (l(), f("p", Dw, S(t.description), 1)) : A("", !0),
          m("div", {
            class: "fu-tz",
            ref_key: "tzRoot",
            ref: d
              ...
              default: fe(() => [
                s.value ? (l(), f("div", Rw, [
                  ...
                  m("ul", {
                    ...
                    y.value.length ? A("", !0) : (l(), f("li", Pw, "No results")),
                    (l(!0), f(j, null, re(y.value, (U, ee) => (l(), f("li", {
                      ...
                      m("span", Bw, S(U.offset), 1),
                      m("span", zw, S(U.city), 1),
                      m("span", Lw, S(U.country), 1)
                    ], 42, Fw))), 128))
                  ], 512)
                ])) : A("", !0)
              ]),
        ...
        m("div", Ww, [
          ...
          Z(He, { name: "fu-slide-right" }, {
            default: fe(() => [
              K.value ? (l(), f("div", Uw, [
                m("div", Yw, [
                  m("p", Gw, S(D(K.value)), 1),
                  m("button", {
                    class: "fu-slots__close",
                    onClick: ue(R, ["stop"])
                  }, "✕")
                ]),
                t.slotsLoading ? (l(), f("div", Kw, [...$[11] || ($[11] = [
                  m("span", { class: "fu-slots__spinner" }, null, -1)
                ])])) : t.slots && t.slots.length ? (l(), f("div", qw, [
...
}), ys = /* @__PURE__ */ ae(Jw, [["__scopeId", "data-v-54e3bb3e"]]), bs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ys
...
}, t1 = { class: "fu-embed-success__sub" }, n1 = {
  key: 1,
  class: "fu-panel"
}, a1 = {
  key: 2,
  class: "fu-panel"
}, i1 = { class: "fu-form-slot-bar" }, r1 = { class: "fu-form-slot-bar__date" }, o1 = { class: "fu-embed-questions" }, s1 = {
  key: 0,
  class: "fu-embed-error"
}, l1 = ["disabled"], u1 = { key: 0 }, c1 = {
  key: 1,
        ...
        u.value === "submitted" ? (l(), f("div", e1, [
          ...
          m("div", o1, [
            (l(!0), f(j, null, re(s.value, (L) => (l(), f(j, {
              ...
              g.value.has(L.id) ? (l(), f("p", s1, "This field is required")) : A("", !0)
            ], 64))), 128))
          ]),
          m("button", {
            ...
            C.value ? (l(), f("span", c1)) : (l(), f("span", u1, "Confirm booking"))
          ], 8, l1)
        ])) : A("", !0)
      ], 64)) : (l(), f("div", Xw, [...x[0] || (x[0] = [
...
}), f1 = /* @__PURE__ */ ae(d1, [["__scopeId", "data-v-50151cce"]]), m1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: f1
}, Symbol.toStringTag, { value: "Module" })), h1 = {
  key: 0,
  class: "service-card__image"
}, v1 = ["src"], p1 = { class: "service-card__content" }, g1 = ["innerHTML"], y1 = ["innerHTML"], b1 = { key: 0 }, C1 = { key: 1 }, w1 = {
  key: 2,
  ...
  setup(t, { emit: e }) {
    ...
    return (d, h) => (l(), f("div", {
      ...
      t.widgetDisplay.showImage !== !1 ? (l(), f("div", h1, [
      ...
      m("div", p1, [
        ...
        t.widgetDisplay.showQuantity !== !1 || t.widgetDisplay.showUnitPrice !== !1 ? (l(), f("div", {
          ...
          t.widgetDisplay.showQuantity !== !1 ? (l(), f("span", b1, S(t.service.quantity) + " " + S(t.service.unit), 1)) : A("", !0),
          t.widgetDisplay.showUnitPrice !== !1 ? (l(), f("span", C1, S(t.service.unitPrice), 1)) : A("", !0)
        ], 4)) : A("", !0),
        t.widgetDisplay.showServicePrice !== !1 ? (l(), f("div", w1, [
          m("div", {
...
}), Cs = /* @__PURE__ */ ae(A1, [["__scopeId", "data-v-636b3791"]]), _1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Cs
}, Symbol.toStringTag, { value: "Module" })), S1 = /* @__PURE__ */ se({
...
}), k1 = /* @__PURE__ */ ae(S1, [["__scopeId", "data-v-d67ca331"]]), ws = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: k1
}, Symbol.toStringTag, { value: "Module" })), T1 = ["innerHTML"], E1 = /* @__PURE__ */ se({
  __name: "TextRenderer",
  props: {
    content: {}
  },
...
}), M1 = /* @__PURE__ */ ae(E1, [["__scopeId", "data-v-25719c05"]]), As = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: M1
}, Symbol.toStringTag, { value: "Module" })), N1 = {
  key: 0,
  class: "fu-empty-state"
}, D1 = ["src"], I1 = /* @__PURE__ */ se({
...
}), O1 = /* @__PURE__ */ ae(I1, [["__scopeId", "data-v-f6e4e3fe"]]), _s = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: O1
}, Symbol.toStringTag, { value: "Module" })), R1 = {
  key: 0,
  class: "fu-filter-dropdown__header"
}, x1 = { class: "fu-filter-dropdown__title" }, $1 = { class: "fu-filter-dropdown__body" }, P1 = { class: "fu-filter-dropdown__footer" }, F1 = /* @__PURE__ */ se({
...
}), B1 = /* @__PURE__ */ ae(F1, [["__scopeId", "data-v-6439f409"]]), z1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: B1
}, Symbol.toStringTag, { value: "Module" })), L1 = {}, H1 = { class: "fu-smart-header" };
function V1(t, e) {
  return l(), f("header", H1, [
    le(t.$slots, "default", {}, void 0, !0)
  ]);
}
const j1 = /* @__PURE__ */ ae(L1, [["render", V1], ["__scopeId", "data-v-317a0cd5"]]), W1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: j1
}, Symbol.toStringTag, { value: "Module" })), U1 = { class: "fu-trash-icon" }, Y1 = /* @__PURE__ */ se({
  __name: "FusionTrashIcon",
  setup(t) {
    return (e, n) => (l(), f("div", U1, [
      Z(oe(Ta), { size: 18 })
    ]));
  }
}), G1 = /* @__PURE__ */ ae(Y1, [["__scopeId", "data-v-7cafc569"]]), K1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: G1
}, Symbol.toStringTag, { value: "Module" })), q1 = { class: "fu-activity-item" }, Q1 = { class: "fu-activity-icon" }, Z1 = { class: "fu-activity-content" }, J1 = { class: "fu-activity-header" }, X1 = { class: "fu-activity-title" }, eA = { class: "fu-activity-status" }, tA = { class: "fu-activity-text" }, nA = { class: "fu-activity-subtitle" }, aA = { class: "fu-activity-footer" }, iA = { class: "fu-activity-timestamp" }, rA = { class: "fu-activity-user" }, oA = /* @__PURE__ */ se({
...
}), Bk = /* @__PURE__ */ ae(Fk, [["__scopeId", "data-v-38315573"]]), zk = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Bk
...
}), hT = /* @__PURE__ */ ae(mT, [["__scopeId", "data-v-ff9bba0a"]]), vT = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: hT
