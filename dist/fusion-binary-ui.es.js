...
const It = ({
  ...
  "svg",
  {
    ...
    height: i,
    stroke: c,
    "stroke-width": it(n) || it(s) || n === !0 || s === !0 ? Number(l || u || Pe["stroke-width"]) * 24 / Number(i) : l || u || Pe["stroke-width"],
    class: Bt(
      "lucide",
      b.class,
...
const Re = me("x", [
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(!1), u = w(null), i = w(null), c = w(n.modelValue || null), b = _t({
      position: "absolute",
      visibility: "hidden",
      opacity: "0",
      zIndex: "9999"
    ...
    function f() {
      ...
      const r = u.value.getBoundingClientRect(), p = i.value.getBoundingClientRect(), R = window.innerHeight - r.bottom, B = r.top, E = R < p.height && B > R;
    ...
    const g = async () => {
      ...
      const p = r.target;
      l.value && u.value && i.value && !u.value.contains(p) && !i.value.contains(p) && (l.value = !1);
    }, y = () => {
      l.value && (l.value = !1);
    }, k = (r) => {
    ...
    return he(() => {
      ...
      e.label ? (t(), o("div", Xt, O(e.label), 1)) : S("", !0),
      a("button", {
        ...
        }, O(c.value?.label || e.placeholder), 3),
        ...
        L(Ve, { name: "fade" }, {
          default: ae(() => [
            l.value ? (t(), o("ul", {
              ...
              (t(!0), o(X, null, te(e.options, (z) => (t(), o("li", {
                key: z.label,
  ...
  setup(e) {
    return (v, n) => (t(), o("div", {
      ...
      e.tooltip ? (t(), o("span", on, O(e.tooltip), 1)) : S("", !0)
    ], 2));
  }
...
const sn = ["src", "alt"], un = {
  ...
  setup(e, { emit: v }) {
    ...
    return (g, d) => (t(), o("div", {
      ...
      a("div", {
        ...
        }, null, 8, sn)) : (t(), o("span", un, O(u.value), 1)),
        e.editable ? (t(), o("span", rn, " Edit ")) : S("", !0),
  ...
  setup(e, { emit: v }) {
    ...
    return (u, i) => (t(), o("div", fn, [
      e.label ? (t(), o("label", vn, O(e.label), 1)) : S("", !0),
      a("div", {
        class: q(["edf-wrapper", [`edf--${e.variant}`]]),
        onMouseenter: i[0] || (i[0] = (c) => s.value = !0),
        onMouseleave: i[1] || (i[1] = (c) => s.value = !1),
        ref: "container"
      }, [
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: v }) {
    const n = e, s = v, l = `fu-input-${Math.random().toString(36).slice(2, 9)}`, u = H(() => n.id || l), i = H(() => n.name || u.value), c = H(() => {
    ...
    return fe(
      ...
      a("div", {
        ...
        Fe(a("input", tt(d.$attrs, {
          ...
          "aria-describedby": e.error ? `${u.value}-error` : void 0,
          inputmode: c.value,
  ...
  setup(e) {
    ...
    function l(u) {
      const i = s(u);
      v.type === "single" ? n.value = i ? [] : [u] : i ? n.value = n.value.filter((c) => c !== u) : n.value.push(u);
    }
    return (u, i) => (t(), o("div", {
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(!1), u = w(""), i = w(null), c = w(null), b = w(null), f = w(null), g = w({}), d = w(null), m = w([]), y = H(() => n.async === !0);
    fe(
      () => n.modelValue,
      (C) => {
    ...
    const k = H(() => y.value || !u.value ? n.options : n.options.filter(
      (C) => C.label.toLowerCase().includes(u.value.toLowerCase())
    ));
    function r() {
      const C = i.value?.querySelector("button, input");
      if (!C) return;
    ...
    function B(C) {
      i.value?.contains(C.target) || c.value?.contains(C.target) || (l.value = !1);
    }
    function E(C) {
      if (!l.value) return;
      const Y = C.target;
    ...
    return he(() => {
      ...
      e.label ? (t(), o("div", Vn, O(e.label), 1)) : S("", !0),
      e.variant === "button" ? (t(), o("div", Tn, [
        a("button", {
          ...
          e.multiple ? (t(), o("div", Fn, [
            ...
            ]))), 128)) : (t(), o("span", In, O(e.placeholder), 1))
          ])) : (t(), o("div", jn, [
            ...
            a("span", null, O(d.value?.label || e.placeholder), 1)
          ])),
          Y[2] || (Y[2] = a("svg", {
        ...
        L(Ve, { name: "fade" }, {
          default: ae(() => [
            l.value ? (t(), o("div", {
              ...
              ])) : (t(), o("div", Wn, O(e.noResultsText), 1))
            ], 4)) : S("", !0)
          ]),
          _: 3
        })
      ])),
      e.error ? (t(), o("span", Rn, O(e.error), 1)) : S("", !0)
    ], 512));
  }
  ...
  setup(e) {
    ...
    return (u, i) => (t(), o("div", {
      ...
      onClick: i[0] || (i[0] = (c) => u.$emit("click"))
    }, [
  ...
  setup(e) {
    return (v, n) => (t(), o("div", {
      ...
      (t(), U(ce(e.link ? "a" : "button"), {
        ...
        default: ae(() => [
          e.loading ? (t(), o("span", Qn)) : S("", !0),
          e.icon ? (t(), U(ce(e.icon), {
            key: 1,
            class: "fu-btn-icon",
            size: 16
          })) : S("", !0),
          e.loading ? (t(), o("span", eo, O(e.loadingText || "Loading..."), 1)) : (t(), o("span", to, [
            Z(v.$slots, "default", {}, () => [
              ie(O(e.text), 1)
            ], !0)
          ]))
      ...
      e.tooltip ? (t(), o("span", no, O(e.tooltip), 1)) : S("", !0)
    ], 6));
  }
  ...
  setup(e) {
    return (v, n) => (t(), o("div", {
      ...
      e.variant === "icon-left" ? (t(), o(X, { key: 0 }, [
        ...
        a("div", so, [
          a("div", io, O(e.value), 1),
          a("div", uo, O(e.title), 1),
          e.subtitle ? (t(), o("div", ro, O(e.subtitle), 1)) : S("", !0)
        ])
      ], 64)) : (t(), o(X, { key: 1 }, [
        a("div", co, O(e.title), 1),
        a("div", fo, O(e.value), 1),
        e.subtitle ? (t(), o("div", vo, O(e.subtitle), 1)) : S("", !0)
      ], 64))
    ], 2));
  }
  ...
  setup(e) {
    return (v, n) => (t(), o("label", {
      ...
      e.label ? (t(), o("span", yo, O(e.label), 1)) : S("", !0)
    ], 10, _o));
  }
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(Array(n.length).fill("")), u = w([]);
    fe(
      () => n.modelValue,
      (f) => {
        if (!f) {
    ...
    function i(f, g) {
      ...
      l.value[f] = m, m && f < n.length - 1 && ve(() => u.value[f + 1]?.focus());
    }
    function c(f) {
      !l.value[f] && f > 0 && ve(() => u.value[f - 1]?.focus());
    }
    function b(f) {
      f.preventDefault();
    ...
    return (f, g) => (t(), o("div", {
      ...
      e.error ? (t(), o("span", Co, O(e.error), 1)) : S("", !0)
    ], 4));
  }
}), xo = /* @__PURE__ */ K(So, [["__scopeId", "data-v-8582d137"]]), zo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: xo
}, Symbol.toStringTag, { value: "Module" })), Oo = ["onKeydown"], Do = { class: "fu-controls" }, Yo = { class: "fu-sliders" }, Vo = ["value"], To = /* @__PURE__ */ ee({
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: v }) {
    const n = e, s = v, l = w("hex"), u = w(!1), i = w(null), c = w({
      top: "0px",
      left: "0px"
    });
    function b() {
      u.value = !u.value, u.value && ve(f);
    }
    function f() {
      if (!i.value) return;
      const _ = i.value.getBoundingClientRect(), $ = 260, M = 320, x = 8;
      let I = _.bottom + 6, V = _.left, W = "top left";
      V + $ > window.innerWidth - x && (V = _.right - $, W = "top right"), V = Math.max(x, V), I + M > window.innerHeight - x && (I = _.top - M - 6, W = W.includes("right") ? "bottom right" : "bottom left"), I = Math.max(x, I), c.value = {
    ...
    function p(_, $, M) {
      $ /= 100, M /= 100;
      const x = M * $, I = x * (1 - Math.abs(_ / 60 % 2 - 1)), V = M - x;
      let W = 0, J = 0, Q = 0;
      return _ < 60 ? [W, J, Q] = [x, I, 0] : _ < 120 ? [W, J, Q] = [I, x, 0] : _ < 180 ? [W, J, Q] = [0, x, I] : _ < 240 ? [W, J, Q] = [0, I, x] : _ < 300 ? [W, J, Q] = [I, 0, x] : [W, J, Q] = [x, 0, I], {
        r: Math.round((W + V) * 255),
        g: Math.round((J + V) * 255),
        b: Math.round((Q + V) * 255)
      };
    }
    function z(_, $, M) {
      _ /= 255, $ /= 255, M /= 255;
      const x = Math.max(_, $, M), I = Math.min(_, $, M), V = x - I;
      let W = 0;
      return V && (x === _ ? W = ($ - M) / V % 6 : x === $ ? W = (M - _) / V + 2 : W = (_ - $) / V + 4, W *= 60, W < 0 && (W += 360)), {
        h: Math.round(W),
        s: Math.round((x === 0 ? 0 : V / x) * 100),
        v: Math.round(x * 100)
      };
    }
    function R(_, $, M) {
      return "#" + [_, $, M].map((x) => x.toString(16).padStart(2, "0")).join("").toUpperCase();
    }
    function B(_, $, M) {
      return `rgb(${_}, ${$}, ${M})`;
    }
  ...
  `
    ...
    function P(_) {
      l.value = "hex";
      const M = _.currentTarget.getBoundingClientRect(), x = Math.min(Math.max(0, _.clientX - M.left), M.width), I = Math.min(Math.max(0, _.clientY - M.top), M.height);
      m.value = Math.round(x / M.width * 100), y.value = Math.round(100 - I / M.height * 100), D();
    }
    return he(() => {
...
}), Fo = /* @__PURE__ */ K(To, [["__scopeId", "data-v-568b3b3c"]]), Bo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Fo
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(!1), u = w(""), i = w(null), c = w(null), b = H(() => {
    ...
    function f(k) {
      const r = {};
      return k.forEach((p) => {
        const z = p.group || "Options";
        r[z] || (r[z] = []), r[z].push(p);
      }), Object.entries(r).map(([p, z]) => ({ title: p, items: z }));
    }
    fe(
      () => n.modelValue,
      (k) => {
        i.value = n.options.find((r) => r.value === k) || null, !l.value && i.value && (u.value = i.value.label);
      },
      { immediate: !0 }
    );
    function g(k) {
      u.value = k.target.value;
    }
    function d(k) {
      i.value = k, u.value = k.label, s("update:modelValue", k.value), l.value = !1;
    }
    function m() {
      l.value = !l.value;
    }
    function y(k) {
      c.value && !c.value.contains(k.target) && (l.value = !1, i.value && (u.value = i.value.label));
    }
    return he(() => {
      ...
      l.value && !e.disabled ? (t(), o("div", Eo, [
        b.value.length > 0 ? (t(!0), o(X, { key: 0 }, te(b.value, (p) => (t(), o("div", {
          ...
          a("div", Po, O(p.title), 1),
          (t(!0), o(X, null, te(p.items, (z) => (t(), o("div", {
            key: z.value,
            ...
            a("div", Ao, [
              Z(k.$slots, "option", { option: z }, () => [
                z.icon ? (t(), U(ce(z.icon), {
                  key: 0,
                  class: "fu-combobox__option-icon"
                })) : S("", !0),
                a("span", null, O(z.label), 1)
              ], !0)
            ]),
            a("div", Wo, [
              z.value === i.value?.value ? (t(), U(G(bt), {
                key: 0,
...
function Ko() {
  return dt || (dt = 1, (function(e, v) {
    (function(n, s) {
      ...
      var n = 1e3, s = 6e4, l = 36e5, u = "millisecond", i = "second", c = "minute", b = "hour", f = "day", g = "week", d = "month", m = "quarter", y = "year", k = "date", r = "Invalid Date", p = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, z = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, R = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function($) {
        var M = ["th", "st", "nd", "rd"], x = $ % 100;
        return "[" + $ + (M[(x - 20) % 10] || M[x] || M[0]) + "]";
      } }, B = function($, M, x) {
        var I = String($);
        return !I || I.length >= M ? $ : "" + Array(M + 1 - I.length).join(x) + $;
      }, E = { s: B, z: function($) {
        var M = -$.utcOffset(), x = Math.abs(M), I = Math.floor(x / 60), V = x % 60;
        return (M <= 0 ? "+" : "-") + B(I, 2, "0") + ":" + B(V, 2, "0");
      }, m: function $(M, x) {
        if (M.date() < x.date()) return -$(x, M);
        var I = 12 * (x.year() - M.year()) + (x.month() - M.month()), V = M.clone().add(I, d), W = x - V < 0, J = M.clone().add(I + (W ? -1 : 1), d);
        return +(-(I + (x - V) / (W ? V - J : J - V)) || 0);
      }, a: function($) {
        return $ < 0 ? Math.ceil($) || 0 : Math.floor($);
      }, p: function($) {
        return { M: d, y, w: g, d: f, D: k, h: b, m: c, s: i, ms: u, Q: m }[$] || String($ || "").toLowerCase().replace(/s$/, "");
      }, u: function($) {
        return $ === void 0;
      } }, C = "en", Y = {};
      Y[C] = R;
      var D = "$isDayjsObject", N = function($) {
        ...
        if (typeof M == "string") {
          ...
          Y[W] && (V = W), x && (Y[W] = x, V = W);
          var J = M.split("-");
          if (!V && J.length > 1) return $(J[0]);
        } else {
          var Q = M.name;
          Y[Q] = M, V = Q;
        }
        return !I && V && (C = V), V || !I && C;
      }, j = function($, M) {
        if (N($)) return $.clone();
        var x = typeof M == "object" ? M : {};
        return x.date = $, x.args = arguments, new P(x);
      }, F = E;
      ...
      var P = (function() {
        function $(x) {
          this.$L = ne(x.locale, null, !0), this.parse(x), this.$x = this.$x || x.x || {}, this[D] = !0;
        }
        var M = $.prototype;
        return M.parse = function(x) {
          this.$d = (function(I) {
            var V = I.date, W = I.utc;
        ...
        }, M.isSame = function(x, I) {
          var V = j(x);
          return this.startOf(I) <= V && V <= this.endOf(I);
        }, M.isAfter = function(x, I) {
          return j(x) < this.startOf(I);
        }, M.isBefore = function(x, I) {
          return this.endOf(I) < j(x);
        }, M.$g = function(x, I, V) {
          return F.u(x) ? this[I] : this.set(V, x);
        }, M.unix = function() {
          return Math.floor(this.valueOf() / 1e3);
        }, M.valueOf = function() {
          return this.$d.getTime();
        }, M.startOf = function(x, I) {
          var V = this, W = !!F.u(I) || I, J = F.p(x), Q = function(Me, h) {
            var T = F.w(V.$u ? Date.UTC(V.$y, h, Me) : new Date(V.$y, h, Me), V);
            return W ? T : T.endOf(f);
          }, re = function(Me, h) {
            return F.w(V.toDate()[Me].apply(V.toDate("s"), (W ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(h)), V);
          ...
          var V, W = F.p(x), J = "set" + (this.$u ? "UTC" : ""), Q = (V = {}, V[f] = J + "Date", V[k] = J + "Date", V[d] = J + "Month", V[y] = J + "FullYear", V[b] = J + "Hours", V[c] = J + "Minutes", V[i] = J + "Seconds", V[u] = J + "Milliseconds", V)[W], re = W === f ? this.$D + (I - this.$W) : I;
          if (W === d || W === y) {
          ...
          var J = F.p(I), Q = function(pe) {
            var ge = j(W);
            return F.w(ge.date(ge.date() + Math.round(pe * x)), W);
          };
          if (J === d) return this.set(d, this.$M + x);
          if (J === y) return this.set(y, this.$y + x);
          if (J === f) return Q(1);
          if (J === g) return Q(7);
          var re = (V = {}, V[c] = s, V[b] = l, V[i] = n, V)[J] || 1, de = this.$d.getTime() + x * re;
          return F.w(de, this);
        }, M.subtract = function(x, I) {
          return this.add(-1 * x, I);
        }, M.format = function(x) {
          var I = this, V = this.$locale();
          if (!this.isValid()) return V.invalidDate || r;
          var W = x || "YYYY-MM-DDTHH:mm:ssZ", J = F.z(this), Q = this.$H, re = this.$m, de = this.$M, pe = V.weekdays, ge = V.months, Ce = V.meridiem, we = function(h, T, A, le) {
            return h && (h[T] || h(I, W)) || A[T].slice(0, le);
          }, ze = function(h) {
            return F.s(Q % 12 || 12, h, "0");
          }, Me = Ce || function(h, T, A) {
            var le = h < 12 ? "AM" : "PM";
            return A ? le.toLowerCase() : le;
          };
          return W.replace(z, (function(h, T) {
            return T || (function(A) {
              switch (A) {
                case "YY":
                ...
                case "MM":
                  return F.s(de + 1, 2, "0");
                case "MMM":
                  return we(V.monthsShort, de, ge, 3);
                case "MMMM":
                  return we(ge, de);
                case "D":
                  return I.$D;
                ...
                case "d":
                  return String(I.$W);
                case "dd":
                  return we(V.weekdaysMin, I.$W, pe, 2);
                case "ddd":
                  return we(V.weekdaysShort, I.$W, pe, 3);
                case "dddd":
                  return pe[I.$W];
                case "H":
                  return String(Q);
        ...
        }, M.diff = function(x, I, V) {
          var W, J = this, Q = F.p(I), re = j(x), de = (re.utcOffset() - this.utcOffset()) * s, pe = this - re, ge = function() {
            return F.m(J, re);
          };
          switch (Q) {
            case y:
          ...
          return Y[this.$L];
        }, M.locale = function(x, I) {
          if (!x) return this.$L;
          var V = this.clone(), W = ne(x, I, !0);
          return W && (V.$L = W), V;
        }, M.clone = function() {
      ...
      return j.prototype = _, [["$ms", u], ["$s", i], ["$m", c], ["$H", b], ["$W", f], ["$M", d], ["$y", y], ["$D", k]].forEach((function($) {
        _[$[1]] = function(M) {
          return this.$g(M, $[0], $[1]);
        };
      })), j.extend = function($, M) {
...
function Zo() {
  return ct || (ct = 1, (function(e, v) {
    (function(n, s) {
      ...
      var n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, s = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, l = /\d/, u = /\d\d/, i = /\d\d?/, c = /\d*[^-_:/,()\s\d]+/, b = {}, f = function(p) {
        ...
        (this.zone || (this.zone = {})).offset = (function(z) {
          if (!z || z === "Z") return 0;
          var R = z.match(/([+-]|\d\d)/g), B = 60 * R[1] + (+R[2] || 0);
        ...
        var R, B = b.meridiem;
        if (B) {
          for (var E = 1; E <= 24; E += 1) if (p.indexOf(B(E, 0, z)) > -1) {
            R = E > 12;
            break;
          }
        } else R = p === (z ? "pm" : "PM");
        ...
        this.milliseconds = +p;
      }], s: [i, g("seconds")], ss: [i, g("seconds")], m: [i, g("minutes")], mm: [i, g("minutes")], H: [i, g("hours")], h: [i, g("hours")], HH: [i, g("hours")], hh: [i, g("hours")], D: [i, g("day")], DD: [u, g("day")], Do: [c, function(p) {
        var z = b.ordinal, R = p.match(/\d+/);
        if (this.day = R[0], z) for (var B = 1; B <= 31; B += 1) z(B).replace(/\[|\]/g, "") === p && (this.day = B);
      }], w: [i, g("week")], ww: [u, g("week")], M: [i, g("month")], MM: [u, g("month")], MMM: [c, function(p) {
        var z = m("months"), R = (m("monthsShort") || z.map((function(B) {
          return B.slice(0, 3);
        }))).indexOf(p) + 1;
        if (R < 1) throw new Error();
        this.month = R % 12 || R;
      }], MMMM: [c, function(p) {
        var z = m("months").indexOf(p) + 1;
        if (z < 1) throw new Error();
        this.month = z % 12 || z;
      }], Y: [/[+-]?\d+/, g("year")], YY: [u, function(p) {
        this.year = f(p);
      }], YYYY: [/\d{4}/, g("year")], Z: d, ZZ: d };
      function r(p) {
        var z, R;
        z = p, R = b && b.formats;
        for (var B = (p = z.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, (function(j, F, P) {
          var _ = P && P.toUpperCase();
          return F || R[P] || n[P] || R[_].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, (function($, M, x) {
            return M || x.slice(1);
          }));
        ...
        return function(j) {
          for (var F = {}, P = 0, _ = 0; P < E; P += 1) {
            ...
            if (typeof $ == "string") _ += $.length;
              ...
              var M = $.regex, x = $.parser, I = j.slice(_), V = M.exec(I)[0];
              x.call(F, V), j = j.replace(V, "");
            }
          }
          return (function(W) {
            var J = W.afternoon;
      ...
      return function(p, z, R) {
        ...
        B.parse = function(C) {
          ...
          if (typeof ne == "string") {
            ...
            F && (_ = N[2]), b = this.$locale(), !j && _ && (b = R.Ls[_]), this.$d = (function(I, V, W, J) {
              try {
                if (["x", "X"].indexOf(V) > -1) return new Date((V === "X" ? 1e3 : 1) * I);
                var Q = r(V)(I), re = Q.year, de = Q.month, pe = Q.day, ge = Q.hours, Ce = Q.minutes, we = Q.seconds, ze = Q.milliseconds, Me = Q.zone, h = Q.week, T = /* @__PURE__ */ new Date(), A = pe || (re || de ? 1 : T.getDate()), le = re || T.getFullYear(), Se = 0;
                re && !de || (Se = de > 0 ? de - 1 : T.getMonth());
                var Te, Oe = ge || 0, Xe = Ce || 0, Je = we || 0, Ze = ze || 0;
                return Me ? new Date(Date.UTC(le, Se, A, Oe, Xe, Je, Ze + 60 * Me.offset * 1e3)) : W ? new Date(Date.UTC(le, Se, A, Oe, Xe, Je, Ze)) : (Te = new Date(le, Se, A, Oe, Xe, Je, Ze), h && (Te = J(Te).week(h).toDate()), Te);
              } catch {
...
const Ct = /* @__PURE__ */ Mt(Go), Qo = { class: "calendar-header" }, ea = { class: "flex flex--gap-sm" }, ta = { key: 0 }, na = { class: "calendar-weekdays" }, oa = { class: "calendar-days" }, aa = ["onClick"], la = {
  ...
  setup(e, { emit: v }) {
    se.extend(Ct);
    const n = e, s = w(!1), l = v, u = w(!1), i = w(null), c = w(null), b = w(null), f = w(se().startOf("month")), g = w(null), d = w({ start: null, end: null }), m = w("00:00"), y = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], k = [
      "Jan",
      "Feb",
      "Mar",
      "Apr",
    ...
    ), z = H(() => p.value + Ie - 1), R = H(
      () => Array.from({ length: Ie }, (h, T) => p.value + T)
    ), B = H(() => {
      const h = f.value.startOf("month").startOf("week"), T = f.value.endOf("month").endOf("week"), A = [];
      let le = h.clone();
    ...
    function D(h) {
      if (!E(h)) {
        if (n.variant === "date-range") {
          !d.value.start || i.value === "start" ? (d.value.start = h.clone(), d.value.end = null, i.value = "end") : h.isBefore(d.value.start, "day") ? (d.value.end = d.value.start.clone(), d.value.start = h.clone()) : d.value.end = h.clone();
          return;
        }
        g.value = h.clone(), l(
          "update:modelValue",
    ...
    function ne(h = null) {
      i.value = h, u.value = !0, n.variant === "date-range" ? d.value.start ? f.value = d.value.start.startOf("month") : f.value = se().startOf("month") : g.value ? f.value = g.value.startOf("month") : f.value = se().startOf("month"), ve(() => {
        _(), window.addEventListener("resize", _), window.addEventListener("click", F);
      });
    }
    function j() {
      u.value = !1, window.removeEventListener("resize", _), window.removeEventListener("click", F);
    }
    function F(h) {
    ...
    function _() {
      ...
      const h = c.value.getBoundingClientRect(), T = b.value.getBoundingClientRect(), A = window.innerHeight - h.bottom, le = h.top, Se = window.scrollY || window.pageYOffset, Te = window.scrollX || window.pageXOffset;
      let Oe;
      A < T.height && le > T.height ? Oe = h.top + Se - T.height - 6 : Oe = h.bottom + Se + 6, P.value = {
        position: "absolute",
        top: `${Oe}px`,
        left: `${h.left + Te}px`,
        zIndex: 9999
    ...
    const $ = H(() => g.value ? n.variant === "date-time" ? g.value.format("YYYY-MM-DD HH:mm") : g.value.format("YYYY-MM-DD") : ""), M = H(() => n.variant !== "date-range" ? "" : d.value.start && d.value.end ? `${d.value.start.format(
      "YYYY-MM-DD"
    )} to ${d.value.end.format("YYYY-MM-DD")}` : d.value.start ? `${d.value.start.format("YYYY-MM-DD")} to ...` : ""), x = H(() => `fu-date-picker--${n.variant}`);
    fe(
      () => n.modelValue,
      (h) => {
        if (n.variant !== "date-range") {
          if (typeof h == "string" && h) {
            const T = se(h);
            if (T.isValid()) {
              g.value = T, f.value = T.startOf("month"), n.variant === "date-time" ? m.value = T.format("h:mm A") : m.value = "00:00";
              return;
            }
          }
    ...
    const ge = H(() => {
      ...
      for (let T = 0; T < 24; T++)
        for (let A = 0; A < 60; A += 15)
          h.push(se().hour(T).minute(A).format("h:mm A"));
      return h;
    }), Ce = H(() => {
      if (!m.value) return ge.value;
      const h = m.value.toLowerCase().replace(/\s+/g, "");
      return ge.value.filter(
        (T) => T.toLowerCase().replace(/\s+/g, "").startsWith(h)
      );
    });
    function we() {
      if (!g.value || !m.value) return;
      const h = String(m.value).trim().toLowerCase(), T = se(
        h,
      ...
      g.value = g.value.hour(T.hour()).minute(T.minute()), m.value = g.value.format("h:mm A"), l("update:modelValue", g.value.format("YYYY-MM-DDTHH:mm")), s.value = !1;
    }
    function ze(h) {
      m.value = h, we();
    }
    ...
    return _e(() => {
      ...
      class: q(["fu-date-picker", x.value]),
      ref_key: "pickerRef",
      ref: c,
      style: oe({ width: e.formWrapperWidth })
    }, [
              ...
              L(ye, {
                ...
                default: ae(() => [
                  r.value === "days" ? (t(), o(X, { key: 0 }, [
                    ie(O(f.value.format("MMMM YYYY")), 1)
                  ], 64)) : r.value === "months" ? (t(), o(X, { key: 1 }, [
                    ie(O(f.value.year()), 1)
                  ], 64)) : (t(), o(X, { key: 2 }, [
                    ie(O(p.value) + " - " + O(z.value), 1)
                  ], 64))
                ]),
                _: 1
              }, 8, ["icon"]),
  ...
  key: 3,
  class: "calendar-time"
}, Ta = { class: "fu-time-input-wrapper" }, Fa = {
  key: 0,
  class: "fu-time-dropdown customScrollBar"
  ...
  setup(e, { emit: v }) {
    ...
    ), z = H(() => p.value + je - 1), R = H(
      () => Array.from({ length: je }, (h, T) => p.value + T)
    ), B = H(() => {
      const h = f.value.startOf("month").startOf("week"), T = f.value.endOf("month").endOf("week"), A = [];
      let le = h.clone();
      for (; le.isBefore(T) || le.isSame(T, "day"); )
      ...
      (t(), U(be, { to: "body" }, [
        u.value ? (t(), o("div", {
          ...
          a("div", {
            ...
            e.variant === "date-time" ? (t(), o("div", Va, [
              a("div", Ta, [
                L(xe, {
                  type: "text",
                  modelValue: m.value,
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(!1), u = w(null), i = w(null), c = w("months"), b = w(se().year()), f = [
      "Jan",
      "Feb",
      "Mar",
      "Apr",
    ...
    function C(_) {
      !u.value?.contains(_.target) && !i.value?.contains(_.target) && E();
    }
    const Y = w({
      position: "absolute",
      top: "0px",
    ...
    function D() {
      if (!u.value || !i.value) return;
      const _ = u.value.getBoundingClientRect(), $ = i.value.getBoundingClientRect(), M = window.innerHeight - _.bottom, x = _.top, I = window.scrollY || window.pageYOffset, V = window.scrollX || window.pageXOffset;
      let W;
      M < $.height && x > $.height ? W = _.top + I - $.height - 6 : W = _.bottom + I + 6, Y.value = {
        position: "absolute",
        top: `${W}px`,
        left: `${_.left + V}px`,
        zIndex: 9999
        ...
        l.value ? (t(), o("div", {
          ...
          a("div", {
            ...
            c.value === "months" ? (t(), o("div", Aa, [
              (t(), o(X, null, te(f, (M, x) => a("div", {
                key: M,
                class: q(["calendar-month", {
                  "calendar-month--selected": k(x),
                  "calendar-month--disabled": r(x)
                }]),
                onClick: (I) => z(x)
              }, O(M), 11, Wa)), 64))
            ])) : (t(), o("div", Ra, [
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(se().startOf("month")), u = w(null), i = w("00:00"), c = w("days"), b = w(!1), f = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], g = [
      "Jan",
      "Feb",
      "Mar",
      "Apr",
      ...
      return F;
    }), p = H(() => r.value), z = () => !1, R = (F) => u.value && F.isSame(u.value, "day");
    function B(F) {
      if (u.value = F.clone(), n.variant === "date-time") {
        const P = se(
    ...
    function ne() {
      if (!u.value) return;
      const F = se(`${u.value.format("YYYY-MM-DD")} ${i.value}`, [
        "YYYY-MM-DD HH:mm",
        "YYYY-MM-DD h:mm A"
      ]);
      F.isValid() && (i.value = F.format("HH:mm"), s("update:modelValue", F.format("YYYY-MM-DDTHH:mm")), b.value = !1);
    }
    function j(F) {
      if (!u.value) return;
      i.value = se(F, "h:mm A").format("HH:mm");
      const P = se(
        `${u.value.format("YYYY-MM-DD")} ${i.value}`,
        "YYYY-MM-DD HH:mm"
      );
    ...
    return fe(
      ...
      (F) => {
        ...
        const P = se(F);
        P.isValid() && (u.value = P, l.value = P.startOf("month"), n.variant === "date-time" && (i.value = P.format("HH:mm")));
      },
      { immediate: !0 }
    ), (F, P) => (t(), o("div", {
        ...
        a("div", Xa, [
          a("button", { onClick: Y }, [
            c.value === "days" ? (t(), o(X, { key: 0 }, [
              ie(O(l.value.format("MMMM YYYY")), 1)
            ], 64)) : c.value === "months" ? (t(), o(X, { key: 1 }, [
              ie(O(l.value.year()), 1)
            ], 64)) : (t(), o(X, { key: 2 }, [
              ie(O(d.value) + " - " + O(m.value), 1)
            ], 64))
          ]),
          a("div", Ja, [
            a("button", { onClick: E }, [
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(n.modelValue || ""), u = w(!1), i = w(!1), c = w(null), b = w(null), f = w({ left: 0, top: 0, bottom: 0, width: 0 }), g = w(null), d = H(() => {
      const Y = [];
      for (let D = 0; D < 24; D++)
    ...
    return he(() => {
      ...
      (t(), U(be, { to: "body" }, [
        u.value ? (t(), o("div", {
          ...
          ref_key: "dropdownRef",
          ref: b,
          class: q(["fu-time-dropdown customScrollBar", { "open-up": i.value }]),
          style: oe({
            left: f.value.left + "px",
            width: f.value.width + "px",
            top: i.value ? f.value.top - ft + "px" : f.value.bottom + "px"
          })
        }, [
  ...
  setup(e, { emit: v }) {
    ...
    return he(() => window.addEventListener("keydown", l)), _e(() => window.removeEventListener("keydown", l)), (u, i) => (t(), U(Ve, { name: "drawer-fade" }, {
      default: ae(() => [
        e.open ? (t(), o("div", pl, [
          a("div", {
            class: "fu-drawer__backdrop",
            onClick: i[0] || (i[0] = (c) => u.$emit("close"))
          }),
          a("div", {
            ...
            a("div", gl, [
              Z(u.$slots, "default", { class: "slot-body" }, void 0, !0)
            ]),
            a("div", {
  ...
  setup(e) {
    const v = e, n = w(!1), s = w(null), l = w(null), u = w({});
    let i = null;
    function c() {
    ...
    function b() {
      ...
      v.align === "right" ? r.left = `${y.right - k}px` : v.align === "center" && (r.left = `${y.left + y.width / 2 - k / 2}px`), u.value = {
        position: "absolute",
        ...r,
        zIndex: "1000"
      };
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(null), u = w(null), i = w(n.modelValue || null), c = w(!1), b = w({});
    fe(
      () => n.modelValue,
      (y) => i.value = y
    ), fe(
    ...
    function g(y) {
      i.value = y, s("update:modelValue", y), s("close"), c.value = !1, u.value?.blur();
    }
    function d(y) {
...
}), Yl = /* @__PURE__ */ K(Dl, [["__scopeId", "data-v-2181a04e"]]), Vl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Yl
  ...
  setup(e, { emit: v }) {
    const n = v, s = e, l = w(!1), u = w(null), i = w(null), c = w({
      top: "0px",
      left: "0px"
    });
    fe(
    ...
    function f() {
      if (!u.value || !i.value) return;
      const r = u.value.getBoundingClientRect(), p = r.bottom + window.scrollY + 6, z = i.value.offsetWidth;
      let R = r.left + window.scrollX;
      s.align === "center" ? R += r.width / 2 - z / 2 : s.align === "right" && (R = r.right - z + window.scrollX), c.value = {
        position: "absolute",
        top: `${p}px`,
        left: `${R}px`,
        zIndex: "2000"
    ...
    function d(r) {
      l.value && u.value && !u.value.contains(r.target) && i.value && !i.value.contains(r.target) && y();
    }
    function m() {
      l.value && y();
    }
        ...
        L(Ve, { name: "fade" }, {
          default: ae(() => [
            l.value ? (t(), o("div", {
              ...
              e.content ? (t(), o("div", Tl, [
                Z(r.$slots, "content", {}, void 0, !0)
              ])) : S("", !0),
              (t(!0), o(X, null, te(e.actions, (z) => (t(), o("div", {
                class: "flex w-100",
                key: z.label
              }, [
                a("a", {
  ...
  setup(e, { expose: v }) {
    const n = e, s = w(!1), l = w(null), u = _t({ top: 0, left: 0 }), i = w(null), c = w(null);
    function b(k) {
    ...
    function g(k) {
      ...
      document.dispatchEvent(new CustomEvent("close-all-editors")), l.value = b(n.modelValue), ve(() => {
        s.value = !0, ve(() => {
          ...
          if (!r || !c.value) return;
          const p = r.getBoundingClientRect(), z = c.value.offsetWidth;
          u.top = p.bottom + 6 + window.scrollY, n.align === "left" ? u.left = p.left + window.scrollX : n.align === "center" ? u.left = p.left + p.width / 2 - z / 2 + window.scrollX : u.left = p.right - z + window.scrollX;
        });
      });
    }
    function d() {
    ...
    function y(k) {
      ...
      ) || (n.mode === "inline" ? i.value && !i.value.contains(r) && d() : c.value && !c.value.contains(r) && d());
    }
    return he(() => {
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(!1), u = w(null), i = w([]), c = w([]);
    function b() {
    ...
    function y(k) {
      i.value.splice(k, 1), c.value.splice(k, 1), s("filesSelected", i.value);
    }
    return (k, r) => (t(), o("div", {
      ...
      a("div", ql, [
        c.value.length ? (t(), o("div", Nl, [
          (t(!0), o(X, null, te(c.value, (p, z) => (t(), o("div", {
            key: p.id,
            class: "fu-upload__preview-item"
          }, [
            a("button", {
              class: "fu-upload__remove",
              onClick: ue((R) => y(z), ["stop"])
            }, " ✕ ", 8, Ul),
            p.isImage ? (t(), o("img", {
              key: 0,
              src: p.src,
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(!1), u = w(null), i = w(null), c = w({
      top: "0px",
      left: "0px"
    }), b = H(() => ({
    ...
    function f(p) {
      p?.stopPropagation();
      const z = !l.value;
      z && document.dispatchEvent(new CustomEvent("close-all-dropdowns")), l.value = z, s("update:isOpen", z), z ? (s("open"), ve(y)) : s("close");
    }
    function g() {
      s("apply", n.payload), m();
    }
    ...
    function y() {
      if (!u.value || !i.value) return;
      const p = u.value.getBoundingClientRect(), z = p.bottom + window.scrollY + 8;
      let R = p.left + window.scrollX;
      n.align === "center" && (R += p.width / 2 - i.value.offsetWidth / 2), n.align === "right" && (R = p.right - i.value.offsetWidth + window.scrollX), c.value = {
        position: "absolute",
        top: `${z}px`,
        left: `${R}px`,
        zIndex: 2e3
    ...
    function k(p) {
      l.value && u.value && !u.value.contains(p.target) && i.value && !i.value.contains(p.target) && m();
    }
    function r() {
      m();
    }
...
const cs = /* @__PURE__ */ K(us, [["render", ds], ["__scopeId", "data-v-317a0cd5"]]), fs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(e, { emit: v }) {
    ...
    return (u, i) => (t(), o("div", _s, [
      ...
      i[0] || (i[0] = a("div", { class: "fu-activity-line" }, null, -1)),
      a("div", ys, [
        a("div", {
          ...
          a("p", Ms, O(e.fileName), 1),
          a("div", Cs, [
            a("span", Ss, O(e.timestamp), 1),
            a("div", xs, [
              L(De, {
  ...
  __proto__: null,
  default: Os
}, Symbol.toStringTag, { value: "Module" })), Ys = { class: "fu-attachment-left flex flex--gap-md flex--align-center" }, Vs = { class: "fu-attachment-preview" }, Ts = ["src", "alt"], Fs = { class: "fu-attachment-info flex flex--column" }, Bs = { class: "fu-attachment-title" }, Is = { class: "fu-attachment-meta" }, js = { class: "fu-attachment-right flex flex--align-center flex--gap-md" }, Es = { class: "flex flex--column flex--align-center" }, Ps = { class: "fu-attachment-time" }, Ls = /* @__PURE__ */ ee({
  ...
  setup(e, { emit: v }) {
    ...
    return (c, b) => (t(), o("div", {
      ...
      a("div", Ys, [
        ...
        a("div", Fs, [
          a("span", Bs, O(e.fileName), 1),
          a("span", Is, O(e.fileSize), 1)
        ])
      ]),
      a("div", js, [
        a("div", Es, [
  ...
  setup(e, { emit: v }) {
    ...
    return (u, i) => (t(), o("div", Qs, [
      a("div", ei, [
        a("div", ti, [
          a("div", ni, O(e.title), 1),
          a("div", oi, [
            a("div", ai, [
              a("span", {
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = n.addItemButtonText || "+ Add Item", u = n.addColumnButtonText || "+ Add Stage", i = w(JSON.parse(JSON.stringify(n.columns || []))), c = w(null), b = w(null), f = w(null);
    fe(
      () => n.columns,
      (B) => {
        i.value = JSON.parse(JSON.stringify(B));
      },
      { deep: !0 }
    );
    function g(B, E) {
    ...
    function y(B, E) {
      const C = c.value;
      if (!C) return;
      const Y = i.value.find((N) => N.id === C.fromColumnId), D = i.value.find((N) => N.id === B);
      !Y || !D || (Y.items = Y.items.filter((N) => N.id !== C.item.id), E === null ? D.items.push(C.item) : D.items.splice(E, 0, C.item), s("update:items", i.value), c.value = null, f.value = null);
    }
    function k(B) {
    ...
    function r(B) {
      ...
      const C = [...i.value], [Y] = C.splice(E, 1);
      C.splice(B, 0, Y), i.value = C.map((D, N) => ({ ...D, position: N + 1 })), s("update:columns", i.value), b.value = null;
    }
    function p() {
      const B = {
      ...
      i.value.push(B), s("update:columns", i.value);
    }
    function z(B, E) {
    ...
    return (B, E) => (t(), o("div", ci, [
      a("div", {
        ...
        (t(!0), o(X, null, te(i.value, (C, Y) => (t(), o("div", {
          key: C.id,
            ...
            a("div", mi, [
              ...
              a("div", _i, [
                a("button", {
                  ...
                  title: G(l),
                  onClick: ue((D) => z(C, Y), ["stop"])
                }, " + ", 8, gi)
              ])
            ]),
            a("div", yi, [
              Z(B.$slots, "column-header", {}, void 0, !0),
              a("span", bi, O(C.items.length), 1)
            ])
          ]),
          e.editMode ? (t(), o("div", wi, [
            ...
            a("div", {
              ...
              C.items.length ? S("", !0) : (t(), o("div", Si, O(e.noItemtext), 1))
            ], 42, ki),
            a("button", {
  ...
  __proto__: null,
  default: Oi
}, Symbol.toStringTag, { value: "Module" })), Yi = { class: "fu-modal__header" }, Vi = { class: "fu-modal__title" }, Ti = { class: "fu-modal__body" }, Fi = {
  key: 0,
  ...
  setup(e) {
    const v = w(!1), n = w(!0), s = w(!1), l = w(340), u = w(!1), i = w(typeof window < "u" ? window.innerWidth : 1200);
    let c = !1;
    const b = w(!1), f = e;
    function g() {
      i.value <= Ge ? (v.value = !v.value, n.value = !0) : n.value = !n.value;
    }
    function d() {
      if (i.value <= Ge) {
    ...
    function m() {
      l.value = u.value ? mt : Xi, u.value = !u.value, R();
    }
    function y(E) {
    ...
    function B() {
      ...
      if (E)
        try {
          ...
          s.value = !!C, l.value = Y || mt, u.value = !!D;
        } catch (C) {
  ...
  setup(e, { emit: v }) {
    ...
    ), u = w(!1), i = w(null), c = w(null), b = w(null), f = w("asc"), g = H(() => !!n.sort), d = H(
              ...
              (t(!0), o(X, null, te(l.value, (P, _) => (t(), o("th", {
                ...
                a("div", {
                  ...
                  a("div", {
                    ...
                    onClick: ($) => z(P),
                    onKeydown: [
                      Ye(ue(($) => z(P), ["prevent"]), ["enter"]),
                      Ye(ue(($) => z(P), ["prevent"]), ["space"])
                    ]
                  }, [
                    ...
                    a("span", tu, O(P.label), 1),
                    P.sortable && d.value === P.key ? (t(), o("span", nu, O(m.value === "asc" ? "▲" : "▼"), 1)) : S("", !0)
                  ], 42, eu),
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = () => {
      ...
      n.isVisible && (n.loading || (g.key === "Enter" && (g.preventDefault(), u()), g.key === "Escape" && l()));
    };
    return he(() => {
    ...
    return he(() => {
      ...
      e.isVisible ? (t(), o("div", _u, [
        a("div", gu, [
          a("header", yu, [
            a("div", bu, [
              Z(i.$slots, "header-left", {}, void 0, !0)
            ]),
            a("div", wu, [
              Z(i.$slots, "header-right", {}, () => [
                L(ye, {
                  variant: "subtle",
                  size: "sm",
                  text: "Close preview",
    ...
    return (v, n) => {
      ...
      return t(), o("div", xu, [
        a("ul", zu, [
          ...
          !e.items || !e.items.length ? (t(), o("li", Ou, "No menu items")) : S("", !0)
        ]),
        Z(v.$slots, "default", {}, void 0, !0)
      ]);
    };
  }
}), Yu = /* @__PURE__ */ K(Du, [["__scopeId", "data-v-7ff3c35c"]]), Vu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Yu
}, Symbol.toStringTag, { value: "Module" })), Tu = { class: "fu-bell-icon" }, Fu = {
  key: 2,
  class: "fu-badge"
}, Bu = /* @__PURE__ */ ee({
  ...
  setup(e) {
    const v = e, n = w(!1), s = w(null), l = w(null), u = w({}), i = () => {
      if (n.value = !n.value, n.value && s.value) {
        const b = s.value.getBoundingClientRect();
        let f = b.left + window.scrollX;
        v.align === "right" ? f = b.right + window.scrollX - 300 : v.align === "center" && (f = b.left + window.scrollX - 160 + b.width / 2), u.value = {
    ...
    return he(() => document.addEventListener("click", c)), _e(() => document.removeEventListener("click", c)), (b, f) => (t(), o("div", {
      ...
      a("div", {
        ...
        a("div", Tu, [
          ...
          e.unreadCount > 0 ? (t(), o("span", Fu, O(e.unreadCount), 1)) : S("", !0)
        ])
      ]),
      (t(), U(be, { to: "body" }, [
        L(Ve, { name: "fade" }, {
  ...
  setup(e) {
    ...
    return (u, i) => (t(), U(be, { to: "body" }, [
      L(Ve, { name: "fu-toast-fade" }, {
        default: ae(() => [
          n.value ? (t(), o("div", {
            key: 0,
  ...
  setup(e, { emit: v }) {
    ...
    }), i = H(() => Math.max(1, Math.ceil(n.total / n.pageSize))), c = H(
    ...
    const d = H(() => {
      const m = [], y = i.value, k = n.page, r = n.siblingCount, p = Math.max(2, k - r), z = Math.min(y - 1, k + r);
      m.push({ key: "p-1", label: "1", page: 1 }), p > 2 && m.push({ key: "e-left", label: "…", ellipsis: !0 });
      for (let R = p; R <= z; R++)
        m.push({ key: `p-${R}`, label: String(R), page: R });
      return z < y - 1 && m.push({ key: "e-right", label: "…", ellipsis: !0 }), y > 1 && m.push({ key: `p-${y}`, label: String(y), page: y }), m;
    });
    return (m, y) => (t(), o("div", Xu, [
      a("div", Ju, [
        e.showInfo ? (t(), o("div", Zu, O(c.value) + "–" + O(b.value) + " of " + O(e.total), 1)) : S("", !0),
  ...
  setup(e) {
    ...
    return (s, l) => (t(), o("div", {
      ...
      e.title || s.$slots.actions ? (t(), o("div", lr, [
        e.title ? (t(), o("h3", sr, O(e.title), 1)) : S("", !0),
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(n.modelValue), u = w(!1), i = () => {
      u.value = !u.value;
    };
    return fe(l, (c) => s("update:modelValue", c)), fe(() => n.modelValue, (c) => l.value = c), (c, b) => (t(), o("div", {
      ...
      a("div", {
        ...
        a("button", {
          ...
          (t(), U(ce(u.value ? G(Wt) : G(Rt)), { class: "fu-password-icon" }))
        ])
      ], 2),
      e.error ? (t(), o("span", pr, O(e.error), 1)) : S("", !0)
    ], 4));
  }
  ...
  setup(e, { emit: v }) {
    ...
    return (i, c) => (t(), o("label", {
      class: q(["fu-radio", [`fu-radio--${e.size}`, { "is-checked": u.value, "is-disabled": e.disabled }]])
    }, [
      a("input", {
        type: "radio",
      ...
      a("span", zr, [
        u.value ? (t(), o("span", Or)) : S("", !0)
      ]),
      i.$slots.default ? (t(), o("span", Dr, [
        Z(i.$slots, "default", {}, void 0, !0)
      ])) : S("", !0)
    ], 2));
  }
}), Vr = /* @__PURE__ */ K(Yr, [["__scopeId", "data-v-3c5ecc5b"]]), Tr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Vr
  ...
  setup(e, { emit: v }) {
    const n = e, s = v;
    function l(i) {
      const c = i.target, b = Number(c.value);
      s("update:modelValue", b), s("change", b);
    }
    const u = H(
      () => n.unit ? `${n.modelValue}${n.unit}` : String(n.modelValue)
    );
    return (i, c) => (t(), o("div", Fr, [
      e.label ? (t(), o("label", Br, O(e.label), 1)) : S("", !0),
      a("div", Ir, [
        a("input", {
          type: "range",
          min: e.min,
...
const _d = /* @__PURE__ */ K(fd, [["render", hd], ["__scopeId", "data-v-b7f6e763"]]), gd = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(e) {
    ...
    return (s, l) => (t(), o("nav", {
      ...
      a("ul", yd, [
        (t(!0), o(X, null, te(e.modules, (u) => (t(), o("li", {
          key: u.name,
          class: q({ active: e.activeModule === u.name })
        }, [
          a("div", {
            class: "fu-sidebar__item",
            onClick: (i) => s.$emit("select", u)
          }, [
            a("div", wd, [
              (t(), U(ce(u.icon), {
              ...
              u.count ? (t(), o("span", kd, O(u.count > 99 ? "99+" : u.count), 1)) : S("", !0)
            ]),
            a("span", $d, O(u.label), 1)
          ], 8, bd)
        ], 2))), 128))
      ])
    ], 4));
  ...
  __proto__: null,
  default: Cd
}, Symbol.toStringTag, { value: "Module" })), xd = ["disabled", "aria-expanded"], zd = ["aria-expanded", "disabled"], Od = ["onClick"], Dd = ["src"], Yd = { class: "fu-split-button__option-label" }, Vd = /* @__PURE__ */ ee({
  ...
  setup(e, { emit: v }) {
    const n = e, s = v, l = w(!1), u = w(null), i = w(null), c = H(() => n.align ?? "right"), b = w({}), f = H(() => `fu-split-button--${n.size ?? "sm"}`), g = H(() => `fu-split-button--${n.variant ?? "solid"}`), d = H(() => ({
    ...
    function y() {
      ...
      const z = i.value.getBoundingClientRect(), R = u.value.offsetWidth, B = {
        top: `${z.bottom + window.scrollY + 4}px`,
        left: `${z.left + window.scrollX}px`
      };
      c.value === "right" ? B.left = `${z.right - R + window.scrollX}px` : c.value === "center" && (B.left = `${z.left + z.width / 2 - R / 2 + window.scrollX}px`), b.value = {
        position: "absolute",
        ...B,
        zIndex: "1000"
      };
    ...
    function k(z) {
      i.value?.contains(z.target) || u.value?.contains(z.target) || (l.value = !1, window.removeEventListener("click", k), window.removeEventListener("resize", y));
    }
    function r() {
      n.disabled || s("main-action");
    }
    function p(z) {
      z.onClick && z.onClick(), s("select", z), l.value = !1, window.removeEventListener("click", k), window.removeEventListener("resize", y);
    }
    return he(() => {
      _e(() => {
...
}), Td = /* @__PURE__ */ K(Vd, [["__scopeId", "data-v-569e263d"]]), Fd = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Td
  ...
  setup(e, { emit: v }) {
    ...
    return (i, c) => (t(), o("button", {
      type: "button",
      class: q(["fu-switch", [{ "fu-switch--checked": e.modelValue, disabled: e.disabled }, u.value]]),
      role: "switch",
  ...
  setup(e, { expose: v, emit: n }) {
    const s = e, l = n, u = w(window.innerWidth <= 768), i = w(""), c = w(null), b = H(
      () => s.tabs.filter((y) => !y.mobileOnly || u.value)
    );
    function f() {
      const y = c.value;
    ...
    function g(y) {
      ...
      !k || k.disabled || (i.value = y, l("tab-change", y), ve(() => {
        const r = c.value;
        r && (r.scrollTop = 0, f());
      }));
    }
    function d() {
      const y = s.tabs[0]?.key, k = u.value ? s.defaultActiveMobile || y : s.defaultActiveDesktop || y;
      i.value = k;
    }
    function m() {
      const y = u.value;
      u.value = window.innerWidth <= 768, y !== u.value && ve(d);
    }
    return he(() => {
      ...
      a("div", Ld, [
        a("div", Ad, [
          (t(!0), o(X, null, te(b.value, (r) => (t(), o("button", {
            key: r.key,
            onClick: (p) => g(r.key),
            class: q(["fu-tab", { "fu-tab--active": i.value === r.key }]),
            disabled: r.disabled
          }, [
            r.avatarSrc || r.avatarText ? (t(), o("div", Rd, [
              r.avatarSrc ? (t(), o("img", {
                ...
                alt: "avatar"
              }, null, 8, Hd)) : (t(), o("div", qd, O(r.avatarText?.charAt(0)?.toUpperCase()), 1))
            ])) : r.icon ? (t(), U(ce(r.icon), {
              key: 1,
              size: 16,
              class: "fu-tab__icon"
            })) : S("", !0),
            !r.avatarSrc && !r.avatarText && r.title ? (t(), o("span", Nd, O(r.title), 1)) : S("", !0),
            typeof r.count == "number" ? (t(), o("span", Ud, O(r.count), 1)) : S("", !0)
          ], 10, Wd))), 128))
        ])
      ]),
      a("div", Kd, [
  ...
  setup(e, { emit: v }) {
    ...
    return fe(l, (u) => s("update:modelValue", u)), fe(
      ...
      e.label ? (t(), o("label", ec, [
        ie(O(e.label) + " ", 1),
        e.required ? (t(), o("span", tc, "*")) : S("", !0)
      ])) : S("", !0),
      Fe(a("textarea", tt(u.$attrs, {
      ...
      e.error ? (t(), o("span", oc, O(e.error), 1)) : S("", !0)
    ]));
  }
  ...
  setup(e, { emit: v }) {
    ...
    return (l, u) => (t(), o("div", ic, [
      a("div", uc, [
        (t(!0), o(X, null, te(e.themes, (i) => (t(), o("div", {
          key: i.key,
          class: q(["fu-theme-card", { "is-active": e.modelValue === i.key }]),
          onClick: (c) => s(i.key),
          tabindex: "0",
          role: "button"
        }, [
          a("div", {
            class: q(["fu-theme-preview", `fu-theme-preview--${i.key}`])
          }, [
            ...
            e.modelValue === i.key ? (t(), o("div", dc, [
              L(G(bt), { class: "fu-check-icon" })
            ])) : S("", !0)
          ], 2),
          a("span", cc, O(i.name), 1)
        ], 10, rc))), 128))
      ])
    ]));
  }
...
Le(zt, !0);
const wc = window.matchMedia("(prefers-color-scheme: dark)");
